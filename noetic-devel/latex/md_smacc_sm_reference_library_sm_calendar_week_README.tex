...
\href{https://reelrbtx.github.io/SMACC_Documentation/master/html/namespacesm__calendar__week.html}{\texttt{ Doxygen Namespace \& Class Reference}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{roslaunch sm\_calendar\_week sm\_calendar\_week.launch}
\end{DoxyCode}
