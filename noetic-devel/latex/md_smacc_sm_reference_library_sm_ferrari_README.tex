...
\href{https://reelrbtx.github.io/SMACC_Documentation/master/html/namespacesm__three__some.html}{\texttt{ Doxygen Namespace \& Class Reference}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{roslaunch sm\_ferrari sm\_ferrari.launch}
\end{DoxyCode}
