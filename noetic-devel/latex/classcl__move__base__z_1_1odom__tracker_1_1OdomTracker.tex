...
\end{center}
\end{figure}
\mbox{\Hypertarget{classcl__move__base__z_1_1odom__tracker_1_1OdomTracker_a9d10e6ce0f462a0cf41db7488ea00494}\label{classcl__move__base__z_1_1odom__tracker_1_1OdomTracker_a9d10e6ce0f462a0cf41db7488ea00494}} 
...
289       acceptBackward = !\hyperlink{classcl__move__base__z_1_1odom__tracker_1_1OdomTracker_a466d18a86df049f0f680e043bb5ea91f}{baseTrajectory\_}.poses.empty() && lastpointdist < 
      \hyperlink{classcl__move__base__z_1_1odom__tracker_1_1OdomTracker_a7155d25d0e8dd9f237a79ff503b80e26}{clearPointDistanceThreshold\_} &&
290                        goalAngleOffset < \hyperlink{classcl__move__base__z_1_1odom__tracker_1_1OdomTracker_a1b79dd86745adfb31db822e0c8106282}{clearAngularDistanceThreshold\_};
291 
292       clearingError = lastpointdist > 2 * \hyperlink{classcl__move__base__z_1_1odom__tracker_1_1OdomTracker_a7155d25d0e8dd9f237a79ff503b80e26}{clearPointDistanceThreshold\_};
293       ROS\_DEBUG\_STREAM(\textcolor{stringliteral}{"[OdomTracker] clearing (accepted: "} << acceptBackward << \textcolor{stringliteral}{") linerr: "} << 
      lastpointdist
294                                                             << \textcolor{stringliteral}{", anglerr: "} << goalAngleOffset);
295     \}
296 
297     \textcolor{comment}{// ROS\_INFO("Backwards, last distance: %lf < %lf accept: %d", dist, minPointDistanceBackwardThresh\_,}
298     \textcolor{comment}{// acceptBackward);}
299     \textcolor{keywordflow}{if} (acceptBackward && \hyperlink{classcl__move__base__z_1_1odom__tracker_1_1OdomTracker_a466d18a86df049f0f680e043bb5ea91f}{baseTrajectory\_}.poses.size() > 1) \textcolor{comment}{/*we always leave at least one
       item, specially interesting}
300 \textcolor{comment}{                                                               for the backward local planner reach the
       backwards goal}
301 \textcolor{comment}{                                                               with precission enough*/}
302     \{
303       \hyperlink{classcl__move__base__z_1_1odom__tracker_1_1OdomTracker_a466d18a86df049f0f680e043bb5ea91f}{baseTrajectory\_}.poses.pop\_back();
304     \}
305     \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (clearingError)
306     \{
307       finished = \textcolor{keyword}{true};
308       ROS\_WARN(\textcolor{stringliteral}{"[OdomTracker] Incorrect odom clearing motion."});
309     \}
310     \textcolor{keywordflow}{else}
311     \{
312       finished = \textcolor{keyword}{true};
314     \}
315   \}
316 
317   \textcolor{keywordflow}{return} acceptBackward;
318 \}
\end{DoxyCode}
Here is the call graph for this function\+:
\nopagebreak
...
\begin{DoxyCode}
325 \{
327   geometry\_msgs::PoseStamped base\_pose;
328 
329   base\_pose.pose = odom.pose.pose;
330   base\_pose.header = odom.header;
331   \hyperlink{classcl__move__base__z_1_1odom__tracker_1_1OdomTracker_a466d18a86df049f0f680e043bb5ea91f}{baseTrajectory\_}.header = odom.header;
332 
333   \textcolor{keywordtype}{bool} enqueueOdomMessage = \textcolor{keyword}{false};
334 
335   \textcolor{keywordtype}{double} dist = -1;
336   \textcolor{keywordflow}{if} (\hyperlink{classcl__move__base__z_1_1odom__tracker_1_1OdomTracker_a466d18a86df049f0f680e043bb5ea91f}{baseTrajectory\_}.poses.empty())
337   \{
338     enqueueOdomMessage = \textcolor{keyword}{true};
339   \}
340   \textcolor{keywordflow}{else}
341   \{
342     \textcolor{keyword}{const} \textcolor{keyword}{auto} &prevPose = \hyperlink{classcl__move__base__z_1_1odom__tracker_1_1OdomTracker_a466d18a86df049f0f680e043bb5ea91f}{baseTrajectory\_}.poses.back().pose;
343     \textcolor{keyword}{const} geometry\_msgs::Point &prevPoint = prevPose.position;
344     \textcolor{keywordtype}{double} prevAngle = tf::getYaw(prevPose.orientation);
345 
346     \textcolor{keyword}{const} geometry\_msgs::Point &currePoint = base\_pose.pose.position;
347     \textcolor{keywordtype}{double} currentAngle = tf::getYaw(base\_pose.pose.orientation);
348 
349     dist = \hyperlink{namespacecl__move__base__z_1_1odom__tracker_a501582a760a02ce0069d95bfc67ca973}{p2pDistance}(prevPoint, currePoint);
350     \textcolor{keywordtype}{double} goalAngleOffset = fabs(angles::shortest\_angular\_distance(prevAngle, currentAngle));
351 
352     \textcolor{comment}{// ROS\_WARN("dist %lf vs min %lf", dist, recordPointDistanceThreshold\_);}
353 
354     \textcolor{keywordflow}{if} (dist > \hyperlink{classcl__move__base__z_1_1odom__tracker_1_1OdomTracker_a3a1173716d527bd182d04656491e01dd}{recordPointDistanceThreshold\_} || goalAngleOffset > 
      \hyperlink{classcl__move__base__z_1_1odom__tracker_1_1OdomTracker_a1274fe5334c109cd9c2339beb9411441}{recordAngularDistanceThreshold\_})
355     \{
356       enqueueOdomMessage = \textcolor{keyword}{true};
357     \}
358     \textcolor{keywordflow}{else}
359     \{
360       \textcolor{comment}{// ROS\_WARN("skip odom, dist: %lf", dist);}
361       enqueueOdomMessage = \textcolor{keyword}{false};
362     \}
363   \}
364 
365   \textcolor{keywordflow}{if} (enqueueOdomMessage)
366   \{
367     \hyperlink{classcl__move__base__z_1_1odom__tracker_1_1OdomTracker_a466d18a86df049f0f680e043bb5ea91f}{baseTrajectory\_}.poses.push\_back(base\_pose);
368   \}
369 
370   \textcolor{keywordflow}{return} enqueueOdomMessage;
371 \}
\end{DoxyCode}
Here is the call graph for this function\+:
\nopagebreak
...
Definition at line 130 of file odom\+\_\+tracker.\+h.
...
Definition at line 139 of file odom\+\_\+tracker.\+h.
