...
A completely minimal state machine example.~\newline
 \href{https://reelrbtx.github.io/SMACC_Documentation/master/html/namespacesm__atomic.html}{\texttt{ Doxygen Namespace \& Class Reference}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{roslaunch sm\_update\_loop sm\_update\_loop.launch}
\end{DoxyCode}
