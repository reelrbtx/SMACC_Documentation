...
\begin{DoxyCode}
47 \{
48     \hyperlink{namespacetesting_1_1internal_a8e8ff5b11e64078831112677156cb111}{std::string} orthogonalkey = demangledTypeName<TOrthogonal>();
...
55         clientBehavior->template configureEventSourceTypes<TOrthogonal, TBehavior>();
56         orthogonal->addClientBehavior(clientBehavior);
57         \textcolor{keywordflow}{return} clientBehavior;
58     \}
59     \textcolor{keywordflow}{else}
60     \{
61         ROS\_ERROR(\textcolor{stringliteral}{"[%s] Skipping client behavior creation in orthogonal [%s]. It does not exist."}, 
...
\begin{DoxyCode}
93 \{
94     \textcolor{keywordflow}{return} this->\hyperlink{classsmacc_1_1ISmaccState_a562bb3f9a3ac16b8be71e4794c9e7523}{getStateMachine}().\hyperlink{classsmacc_1_1ISmaccStateMachine_aeda2d6813c6c428bf318a5792e014b61}{getGlobalSMData}(
...
References generate\+\_\+debs\+::args, testing\+::\+Args(), configure(), create\+State\+Reactor(), get\+Class\+Name(), get\+Global\+S\+M\+Data(), interactive\+\_\+marker\+::name, nh, notify\+Transition(), notify\+Transition\+From\+Transition\+Type\+Info(), post\+Event(), requires\+Client(), requires\+Component(), and set\+Global\+S\+M\+Data().
...
22         \{
23             \hyperlink{namespacetesting_1_1internal_a8e8ff5b11e64078831112677156cb111}{std::string} transitionCandidateName = transition.transitionTypeInfo->getFullName();
...
40         \{
41             \hyperlink{namespacetesting_1_1internal_a8e8ff5b11e64078831112677156cb111}{std::string} transitionCandidateName = transition.transitionTypeInfo->getFullName();
...
54             \{
55                 \hyperlink{namespacetesting_1_1internal_a8e8ff5b11e64078831112677156cb111}{std::string} transitionCandidateName = transition.transitionTypeInfo->getFullName
      ();
...
Definition at line 152 of file smacc\+\_\+state\+\_\+impl.\+h.
...
85     \}
86 
87     ROS\_ERROR(\textcolor{stringliteral}{"[%s] Client of type '%s' not found in any orthogonal of the current state machine. This may
...
Definition at line 68 of file smacc\+\_\+state\+\_\+impl.\+h.
...
\begin{DoxyCode}
101 \{
102     this->\hyperlink{classsmacc_1_1ISmaccState_a562bb3f9a3ac16b8be71e4794c9e7523}{getStateMachine}().\hyperlink{classsmacc_1_1ISmaccStateMachine_a8588f9e580fbb95b53e2bd2ca3ff1f98}{setGlobalSMData}(\hyperlink{namespaceinteractive__marker_a447655961b3d3ca3c5a2a9d3d769436d}{name}, value);
103 \}
\end{DoxyCode}
Here is the caller graph for this function\+:
\nopagebreak
