...
\begin{DoxyCode}
227   \{
228     \textcolor{keyword}{auto} *thisobject = \textcolor{keyword}{static\_cast<}MostDerived *\textcolor{keyword}{>}(\textcolor{keyword}{this});
229     \textcolor{keyword}{auto} condition = boost::bind(conditionFn, thisobject);
230     \textcolor{keywordtype}{bool} conditionResult = condition();
231 
232     \textcolor{comment}{//ROS\_INFO("LOOP EVENT CONDITION: %d", conditionResult);}
233     \textcolor{keywordflow}{if} (conditionResult)
234     \{
235       this->postEvent<EvLoopContinue<MostDerived>>();
236     \}
237     \textcolor{keywordflow}{else}
238     \{
239       this->postEvent<EvLoopEnd<MostDerived>>();
240     \}
241     ROS\_INFO(\textcolor{stringliteral}{"[]%s POST THROW CONDITION"}, \hyperlink{smacc__state__base_8h_a0d7815723706a488b5bb65f7e3acf584}{STATE\_NAME});
242   \}
\end{DoxyCode}
...
179   \{
180 
181     ROS\_INFO(\textcolor{stringliteral}{"[%s] Runtime configure orthogonal %s -> %s"}, \hyperlink{smacc__state__base_8h_a0d7815723706a488b5bb65f7e3acf584}{STATE\_NAME}, 
      \hyperlink{namespacesmacc_1_1introspection_a2f495108db3e57604d8d3ff5ef030302}{demangleSymbol}(\textcolor{keyword}{typeid}(TOrthogonal).\hyperlink{namespaceinteractive__marker_a447655961b3d3ca3c5a2a9d3d769436d}{name}()).c\_str(), 
      \hyperlink{namespacesmacc_1_1introspection_a2f495108db3e57604d8d3ff5ef030302}{demangleSymbol}(\textcolor{keyword}{typeid}(TBehavior).\hyperlink{namespaceinteractive__marker_a447655961b3d3ca3c5a2a9d3d769436d}{name}()).c\_str());
182 
183     \hyperlink{structsmacc_1_1introspection_1_1ClientBehaviorInfoEntry}{ClientBehaviorInfoEntry} bhinfo;
184     bhinfo.\hyperlink{structsmacc_1_1introspection_1_1ClientBehaviorInfoEntry_abb0863623802e0107c659e61931518f4}{factoryFunction} = [=](ISmaccState *state) \{
185       \textcolor{comment}{//auto bh = std::make\_shared<TBehavior>(args...);}
186       state->configure<TOrthogonal, TBehavior>(\hyperlink{namespacegenerate__debs_a75f9143e38df82d83b2e8a6f99cae02c}{args}...);
187     \};
188 
189     bhinfo.behaviorType = &(\textcolor{keyword}{typeid}(TBehavior));
190     bhinfo.orthogonalType = &(\textcolor{keyword}{typeid}(TOrthogonal));
191 
192     \textcolor{keyword}{const} std::type\_info *tindex = &(\textcolor{keyword}{typeid}(MostDerived));
193     \textcolor{keywordflow}{if} (!\hyperlink{classsmacc_1_1introspection_1_1SmaccStateInfo_ad3d8b3450060cb0b91f38fb2fe0a7678}{SmaccStateInfo::staticBehaviorInfo}.count(tindex))
194       \hyperlink{classsmacc_1_1introspection_1_1SmaccStateInfo_ad3d8b3450060cb0b91f38fb2fe0a7678}{SmaccStateInfo::staticBehaviorInfo}[tindex] = 
      std::vector<ClientBehaviorInfoEntry>();
195 
196     \hyperlink{classsmacc_1_1introspection_1_1SmaccStateInfo_ad3d8b3450060cb0b91f38fb2fe0a7678}{SmaccStateInfo::staticBehaviorInfo}[tindex].push\_back(bhinfo);
197   \}
\end{DoxyCode}
...
299 
300     ROS\_DEBUG(\textcolor{stringliteral}{"[%s] nodehandle namespace: %s"}, \hyperlink{smacc__state__base_8h_a0d7815723706a488b5bb65f7e3acf584}{STATE\_NAME}, \hyperlink{classsmacc_1_1ISmaccState_a13fe6e6abfdb87996402189d44b78494}{nh}.getNamespace().c\_str());
301 
...
305     \{
306       ROS\_INFO(\textcolor{stringliteral}{"[%s] -- STATIC STATE DESCRIPTION --"}, \hyperlink{smacc__state__base_8h_a0d7815723706a488b5bb65f7e3acf584}{STATE\_NAME});
307 
...
309       \{
310         ROS\_DEBUG(\textcolor{stringliteral}{"[%s] state info: %s"}, \hyperlink{smacc__state__base_8h_a0d7815723706a488b5bb65f7e3acf584}{STATE\_NAME},  \hyperlink{namespacesmacc_1_1introspection_a2f495108db3e57604d8d3ff5ef030302}{demangleSymbol}(
...
312         \{
313           ROS\_DEBUG(\textcolor{stringliteral}{"[%s] client behavior: %s"}, \hyperlink{smacc__state__base_8h_a0d7815723706a488b5bb65f7e3acf584}{STATE\_NAME},  
...
322       \{
323         ROS\_INFO(\textcolor{stringliteral}{"[%s] Creating static client behavior: %s"}, \hyperlink{smacc__state__base_8h_a0d7815723706a488b5bb65f7e3acf584}{STATE\_NAME}, 
      \hyperlink{namespacesmacc_1_1introspection_a2f495108db3e57604d8d3ff5ef030302}{demangleSymbol}(bhinfo.behaviorType->name()).c\_str());
...
328       \{
329         ROS\_INFO(\textcolor{stringliteral}{"[%s] Creating static state reactor: %s"}, \hyperlink{smacc__state__base_8h_a0d7815723706a488b5bb65f7e3acf584}{STATE\_NAME},  
...
331       \}
332 
333       ROS\_INFO(\textcolor{stringliteral}{"[%s] ---- END STATIC DESCRIPTION"}, \hyperlink{smacc__state__base_8h_a0d7815723706a488b5bb65f7e3acf584}{STATE\_NAME});
334     \}
335 
336     ROS\_INFO(\textcolor{stringliteral}{"[%s] State runtime configuration"}, \hyperlink{smacc__state__base_8h_a0d7815723706a488b5bb65f7e3acf584}{STATE\_NAME});
337 
...
342     this->\hyperlink{classsmacc_1_1SmaccState_afc39f8e0ca4001b2159a100da2fccd0e}{getStateMachine}().\hyperlink{classsmacc_1_1ISmaccStateMachine_a7377ca0f79289fdc27f9ed3ff6e67263}{notifyOnRuntimeConfigured}(
      static\_cast<MostDerived *>(\textcolor{keyword}{this}));
343 
344     ROS\_INFO(\textcolor{stringliteral}{"[%s] State OnEntry"}, \hyperlink{smacc__state__base_8h_a0d7815723706a488b5bb65f7e3acf584}{STATE\_NAME});
345 
346     \textcolor{comment}{// finally we go to the derived state onEntry Function}
347     \textcolor{keyword}{static\_cast<}MostDerived *\textcolor{keyword}{>}(\textcolor{keyword}{this})->\hyperlink{classsmacc_1_1SmaccState_a4a10a74fdbe51a798b8d651668b8ed9a}{onEntry}();
348     ROS\_INFO(\textcolor{stringliteral}{"[%s] State OnEntry code finished"}, \hyperlink{smacc__state__base_8h_a0d7815723706a488b5bb65f7e3acf584}{STATE\_NAME});
349 
350     \textcolor{comment}{// here orthogonals and client behaviors are entered OnEntry}
351     this->\hyperlink{classsmacc_1_1SmaccState_afc39f8e0ca4001b2159a100da2fccd0e}{getStateMachine}().\hyperlink{classsmacc_1_1ISmaccStateMachine_a856cf2d25d84659b974cccfbf44aeec9}{notifyOnStateEntryEnd}(
      static\_cast<MostDerived *>(\textcolor{keyword}{this}));
352   \}
\end{DoxyCode}
...
Definition at line 277 of file smacc\+\_\+state\+\_\+base.\+h.


\begin{DoxyCode}
280   \{    
281     \textcolor{comment}{// allocating in memory}
...
284 
285     ROS\_INFO(\textcolor{stringliteral}{"[%s] State object created. Initializating..."}, \hyperlink{smacc__state__base_8h_a0d7815723706a488b5bb65f7e3acf584}{STATE\_NAME});
