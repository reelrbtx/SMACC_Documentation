...
References demangle\+Symbol(), interactive\+\_\+marker\+::name, and generate\+\_\+debs\+::type.


\begin{DoxyCode}
349 \{
350     \textcolor{comment}{/* something when T has toString ... */}
351     ROS\_INFO\_STREAM(\textcolor{stringliteral}{"EXECUTING ONDEFINITION: "} << \hyperlink{namespacesmacc_1_1introspection_a2f495108db3e57604d8d3ff5ef030302}{demangleSymbol}(\textcolor{keyword}{typeid}(T).
...
References demangle\+Symbol(), and interactive\+\_\+marker\+::name.


\begin{DoxyCode}
358 \{
359     ROS\_INFO\_STREAM(\textcolor{stringliteral}{"static OnDefinition: dont exist for "} << \hyperlink{namespacesmacc_1_1introspection_a2f495108db3e57604d8d3ff5ef030302}{demangleSymbol}(\textcolor{keyword}{typeid}(T).
      \hyperlink{namespaceinteractive__marker_a447655961b3d3ca3c5a2a9d3d769436d}{name}()));
...
\begin{DoxyCode}
82 \{
83     \textcolor{keywordflow}{return} \hyperlink{namespacesmacc_1_1introspection_aa9158a0ff0cfe83a59877e6af7d7f873}{demangleSymbol}(\textcolor{keyword}{typeid}(T).\hyperlink{namespaceinteractive__marker_a447655961b3d3ca3c5a2a9d3d769436d}{name}());
84 \}
\end{DoxyCode}
Here is the call graph for this function\+:
\nopagebreak
...
\begin{DoxyCode}
52 \{
53     \textcolor{keywordflow}{return} \hyperlink{namespacesmacc_1_1introspection_aa9158a0ff0cfe83a59877e6af7d7f873}{demangleSymbol}(\hyperlink{namespaceinteractive__marker_a447655961b3d3ca3c5a2a9d3d769436d}{name}.c\_str());
54 \}
\end{DoxyCode}
...
60     \textcolor{keywordtype}{char} *res = abi::\_\_cxa\_demangle(\hyperlink{namespaceinteractive__marker_a447655961b3d3ca3c5a2a9d3d769436d}{name}, 0, 0, &status);
61     \textcolor{keywordflow}{if} (res)
62     \{
63         \textcolor{keyword}{const} \hyperlink{namespacetesting_1_1internal_a8e8ff5b11e64078831112677156cb111}{std::string} demangled\_name(res);
64         std::free(res);
65         \textcolor{keywordflow}{return} demangled\_name;
66     \}
67     \textcolor{comment}{// Demangling failed, fallback to mangled name}
68     \textcolor{keywordflow}{return} \hyperlink{namespacetesting_1_1internal_a8e8ff5b11e64078831112677156cb111}{std::string}(\hyperlink{namespaceinteractive__marker_a447655961b3d3ca3c5a2a9d3d769436d}{name});
69 \textcolor{preprocessor}{#else}
70     \textcolor{keywordflow}{return} \hyperlink{namespacetesting_1_1internal_a8e8ff5b11e64078831112677156cb111}{std::string}(\hyperlink{namespaceinteractive__marker_a447655961b3d3ca3c5a2a9d3d769436d}{name});
...
\begin{DoxyCode}
76 \{
77     \textcolor{keywordflow}{return} \hyperlink{namespacesmacc_1_1introspection_aa9158a0ff0cfe83a59877e6af7d7f873}{demangleSymbol}(\textcolor{keyword}{typeid}(T).\hyperlink{namespaceinteractive__marker_a447655961b3d3ca3c5a2a9d3d769436d}{name}());
78 \}
\end{DoxyCode}
Here is the call graph for this function\+:
\nopagebreak
...
\begin{DoxyCode}
244 \{
245     \hyperlink{namespacetesting_1_1internal_a8e8ff5b11e64078831112677156cb111}{std::string} output;
...
References demangle\+Symbol(), interactive\+\_\+marker\+::name, and smacc\+::introspection\+::\+Walk\+States\+Executor$<$ Initial\+State\+Type $>$\+::walk\+States().
...
161     ROS\_INFO(\textcolor{stringliteral}{"State %s Walker transition: %s"}, sourceState->toShortName().c\_str(), 
      \hyperlink{namespacesmacc_1_1introspection_a2f495108db3e57604d8d3ff5ef030302}{demangleSymbol}(\textcolor{keyword}{typeid}(Ev).\hyperlink{namespaceinteractive__marker_a447655961b3d3ca3c5a2a9d3d769436d}{name}()).c\_str());
162     \hyperlink{namespacetesting_1_1internal_a8e8ff5b11e64078831112677156cb111}{std::string} transitionTag;
163     \hyperlink{namespacetesting_1_1internal_a8e8ff5b11e64078831112677156cb111}{std::string} transitionType;
164 
...
Referenced by testing\+::internal\+::edit\+\_\+distance\+::\+Calculate\+Optimal\+Edits(), upload.\+Mercurial\+V\+C\+S\+::\+Get\+Base\+File(), upload.\+Version\+Control\+System\+::\+Get\+Base\+Files(), smacc\+::introspection\+::\+Type\+Info\+::get\+Type\+Info\+From\+String(), replace\+\_\+back(), and upload\+::\+Split\+Patch().
