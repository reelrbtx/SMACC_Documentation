...
\begin{DoxyCompactItemize}
\item 
{\footnotesize template$<$typename Event\+Type $>$ }\\void \hyperlink{classsmacc_1_1ISmaccStateMachine_acf38a22ca5aa3c7ed51a55cffdb661d5}{propagate\+Event\+To\+State\+Behaviors} (\hyperlink{classsmacc_1_1ISmaccState}{I\+Smacc\+State} $\ast$st, Event\+Type $\ast$ev)
\end{DoxyCompactItemize}
...
Definition at line 279 of file smacc\+\_\+state\+\_\+machine\+\_\+impl.\+h.
...
\begin{DoxyCode}
280 \{
281     static\_assert(std::is\_base\_of<ISmaccState, TSmaccObjectType>::value || std::is\_base\_of<ISmaccClient,
       TSmaccObjectType>::value || std::is\_base\_of<SmaccClientBehavior, TSmaccObjectType>::value || 
      std::is\_base\_of<StateBehavior, TSmaccObjectType>::value || std::is\_base\_of<ISmaccComponent, TSmaccObjectType>::value, \textcolor{stringliteral}{"Only
       are accepted smacc types as subscribers for smacc signals"});
282 
283     \textcolor{keyword}{typedef} decltype(callback) ft;
284     \hyperlink{structsmacc_1_1utils_1_1Bind}{Bind}<\hyperlink{namespaceboost}{boost}::function\_types::function\_arity<ft>::value> binder;
285     \hyperlink{namespaceboost}{boost}::signals2::connection connection = binder.bindaux(signal, callback, \textcolor{keywordtype}{object});
286 
287     if (std::is\_base\_of<ISmaccComponent, TSmaccObjectType>::value)
288     \{
289     \}
290     \textcolor{keywordflow}{else} \textcolor{comment}{// state life-time objects}
291     \{
292         ROS\_WARN(\textcolor{stringliteral}{"[StateMachine] life-time constrained smacc signal subscription created"});
293         \hyperlink{classsmacc_1_1ISmaccStateMachine_aaf98bb0edaa5d8c84767e4acfad3548d}{stateCallbackConnections}.push\_back(connection);
294     \}
295     \textcolor{keywordflow}{return} connection;
296 \}
\end{DoxyCode}
...
Definition at line 299 of file smacc\+\_\+state\+\_\+machine\+\_\+impl.\+h.


\begin{DoxyCode}
300 \{
301     \textcolor{keywordflow}{return} signal.connect(callback);
302     \textcolor{comment}{// return signal;}
303 \}
\end{DoxyCode}
...
Definition at line 306 of file smacc\+\_\+state\+\_\+machine\+\_\+impl.\+h.


\begin{DoxyCode}
307 \{
308     \textcolor{keywordflow}{return} \hyperlink{classsmacc_1_1ISmaccStateMachine_ad8877bcca9dbb345fe72cca839c93dd3}{nh\_}.getParam(param\_name, param\_storage);
309 \}
\end{DoxyCode}
...
Definition at line 339 of file smacc\+\_\+state\+\_\+machine\+\_\+impl.\+h.


\begin{DoxyCode}
340 \{
341     \textcolor{keywordflow}{for} (\textcolor{keyword}{auto} pair : this->\hyperlink{classsmacc_1_1ISmaccStateMachine_a6d7c344ce2570b35737a1173633d0d71}{orthogonals\_})
342     \{
343         ROS\_INFO(\textcolor{stringliteral}{"ortho onentry: %s"}, pair.second->getName().c\_str());
344         \textcolor{keyword}{auto} &orthogonal = pair.second;
345         orthogonal->onEntry();
346     \}
347 
348     this->\hyperlink{classsmacc_1_1ISmaccStateMachine_ad246a49015fadaeb0b1639d7ab99f7d0}{updateStatusMessage}();
349 \}
\end{DoxyCode}
...
327 \{
328 std:
329     lock\_guard<std::recursive\_mutex> lock(\hyperlink{classsmacc_1_1ISmaccStateMachine_aac785541646e5c517273bf31072505a1}{m\_mutex\_});
330 
331     ROS\_INFO\_STREAM(\textcolor{stringliteral}{"Notification State Entry, orthogonals:"} << this->
...
332 
333     \hyperlink{classsmacc_1_1ISmaccStateMachine_ab41ee07d20715142e2f7c92d551b2bd6}{stateSeqCounter\_}++;
334     \hyperlink{classsmacc_1_1ISmaccStateMachine_a9c6e7745205bcce80a301f2fbe8f7e99}{currentState\_} = state;
335     \hyperlink{classsmacc_1_1ISmaccStateMachine_a95e42f735cecdc231ad5372bf9fe7eaf}{currentStateInfo\_} = \hyperlink{classsmacc_1_1ISmaccStateMachine_a5ec3201cbddab4f062f572fb33021041}{info\_}->getState<StateType>();
336 \}
\end{DoxyCode}
...
Definition at line 352 of file smacc\+\_\+state\+\_\+machine\+\_\+impl.\+h.


\begin{DoxyCode}
353 \{
354     ROS\_INFO\_STREAM(\textcolor{stringliteral}{"Notification State Exit: leaving state"} << state);
355     \textcolor{keywordflow}{for} (\textcolor{keyword}{auto} pair : this->\hyperlink{classsmacc_1_1ISmaccStateMachine_a6d7c344ce2570b35737a1173633d0d71}{orthogonals\_})
356     \{
357         \textcolor{keyword}{auto} &orthogonal = pair.second;
358         orthogonal->onExit();
359     \}
360 
361     \textcolor{keywordflow}{for} (\textcolor{keyword}{auto} &conn : this->\hyperlink{classsmacc_1_1ISmaccStateMachine_aaf98bb0edaa5d8c84767e4acfad3548d}{stateCallbackConnections})
362     \{
363         ROS\_WARN\_STREAM(\textcolor{stringliteral}{"[StateMachine] Disconnecting scoped-lifetime SmaccSignal subscription"});
364         conn.disconnect();
365     \}
366 
367     this->stateCallbackConnections.clear();
368 
369     \hyperlink{classsmacc_1_1ISmaccStateMachine_a9c6e7745205bcce80a301f2fbe8f7e99}{currentState\_} = \textcolor{keyword}{nullptr};
370 \}
\end{DoxyCode}
...
\begin{DoxyCode}
321 \{
322     \textcolor{keywordflow}{return} \hyperlink{classsmacc_1_1ISmaccStateMachine_ad8877bcca9dbb345fe72cca839c93dd3}{nh\_}.param(param\_name, param\_val, default\_val);
323 \}
\end{DoxyCode}
...
Referenced by smacc\+::\+I\+Smacc\+Client\+::post\+Event(), smacc\+::\+I\+Smacc\+Component\+::post\+Event(), smacc\+::\+Smacc\+Client\+Behavior\+::post\+Event(), and smacc\+::\+State\+Behavior\+::set\+Output\+Event().
...
133     \textcolor{comment}{// we reach this place. Now, we propagate the events to all the state state behaviors to generate}
...
139     \{
140         \hyperlink{classsmacc_1_1ISmaccStateMachine_acf38a22ca5aa3c7ed51a55cffdb661d5}{propagateEventToStateBehaviors}(currentstate, ev);
141     \}
142 
...
151 \}
\end{DoxyCode}
\index{smacc\+::\+I\+Smacc\+State\+Machine@{smacc\+::\+I\+Smacc\+State\+Machine}!propagate\+Event\+To\+State\+Behaviors@{propagate\+Event\+To\+State\+Behaviors}}
\index{propagate\+Event\+To\+State\+Behaviors@{propagate\+Event\+To\+State\+Behaviors}!smacc\+::\+I\+Smacc\+State\+Machine@{smacc\+::\+I\+Smacc\+State\+Machine}}
\subsubsection[{\texorpdfstring{propagate\+Event\+To\+State\+Behaviors(\+I\+Smacc\+State $\ast$st, Event\+Type $\ast$ev)}{propagateEventToStateBehaviors(ISmaccState *st, EventType *ev)}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$typename Event\+Type $>$ void smacc\+::\+I\+Smacc\+State\+Machine\+::propagate\+Event\+To\+State\+Behaviors (
\begin{DoxyParamCaption}
\item[{{\bf I\+Smacc\+State} $\ast$}]{st, }
\item[{Event\+Type $\ast$}]{ev}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [private]}}\hypertarget{classsmacc_1_1ISmaccStateMachine_acf38a22ca5aa3c7ed51a55cffdb661d5}{}\label{classsmacc_1_1ISmaccStateMachine_acf38a22ca5aa3c7ed51a55cffdb661d5}


Definition at line 374 of file smacc\+\_\+state\+\_\+machine\+\_\+impl.\+h.



References smacc\+::\+I\+Smacc\+State\+::get\+Class\+Name(), smacc\+::\+I\+Smacc\+State\+::get\+Parent\+State(), and smacc\+::\+I\+Smacc\+State\+::get\+State\+Behaviors().


\begin{DoxyCode}
375 \{
376     ROS\_DEBUG(\textcolor{stringliteral}{"PROPAGATING EVENT [%s] TO LUs [%s]: "}, demangleSymbol<EventType>().c\_str(), st->getClassName
      ().c\_str());
377     \textcolor{keywordflow}{for} (\textcolor{keyword}{auto} &sb : st->getStateBehaviors())
378     \{
379         sb->notifyEvent(ev);
380     \}
381 
382     \textcolor{keyword}{auto} *pst = st->getParentState();
383     \textcolor{keywordflow}{if} (pst != \textcolor{keyword}{nullptr})
384     \{
385         \hyperlink{classsmacc_1_1ISmaccStateMachine_acf38a22ca5aa3c7ed51a55cffdb661d5}{propagateEventToStateBehaviors}(pst, ev);
386     \}
387 \}
\end{DoxyCode}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{classsmacc_1_1ISmaccStateMachine_acf38a22ca5aa3c7ed51a55cffdb661d5_cgraph}
\end{center}
\end{figure}
...
Definition at line 313 of file smacc\+\_\+state\+\_\+machine\+\_\+impl.\+h.


\begin{DoxyCode}
314 \{
315     \textcolor{keywordflow}{return} \hyperlink{classsmacc_1_1ISmaccStateMachine_ad8877bcca9dbb345fe72cca839c93dd3}{nh\_}.setParam(param\_name, param\_val);
316 \}
\end{DoxyCode}
