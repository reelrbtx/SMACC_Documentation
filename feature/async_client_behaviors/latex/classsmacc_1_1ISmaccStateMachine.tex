...
Definition at line 477 of file smacc\+\_\+state\+\_\+machine\+\_\+impl.\+h.
...
\begin{DoxyCode}
289 \{
290   static\_assert(std::is\_base\_of<ISmaccState, TSmaccObjectType>::value ||
291                     std::is\_base\_of<ISmaccClient, TSmaccObjectType>::value ||
292                     std::is\_base\_of<ISmaccClientBehavior, TSmaccObjectType>::value ||
293                     std::is\_base\_of<StateReactor, TSmaccObjectType>::value ||
294                     std::is\_base\_of<ISmaccComponent, TSmaccObjectType>::value,
295                 \textcolor{stringliteral}{"Only are accepted smacc types as subscribers for smacc signals"});
296 
297   \textcolor{keyword}{typedef} decltype(\hyperlink{servers_2opencv__perception__node_2opencv__perception__node_8cpp_a050e697bd654facce10ea3f6549669b3}{callback}) ft;
298   \hyperlink{structsmacc_1_1utils_1_1Bind}{Bind<boost::function\_types::function\_arity<ft>::value}
      > binder;
299   boost::signals2::connection connection = binder.\hyperlink{structsmacc_1_1utils_1_1Bind_aa0f4ba76fbd5fdb865df51b61d4269f3}{bindaux}(signal, 
...
300 
301   \textcolor{comment}{// long life-time objects}
302   \textcolor{keywordflow}{if} (std::is\_base\_of<ISmaccComponent, TSmaccObjectType>::value ||
303       std::is\_base\_of<ISmaccClient, TSmaccObjectType>::value ||
304       std::is\_base\_of<ISmaccOrthogonal, TSmaccObjectType>::value ||
305       std::is\_base\_of<ISmaccStateMachine, TSmaccObjectType>::value)
306   \{
307   \}
308   \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (std::is\_base\_of<ISmaccState, TSmaccObjectType>::value ||
309            std::is\_base\_of<StateReactor, TSmaccObjectType>::value ||
310            std::is\_base\_of<ISmaccClientBehavior, TSmaccObjectType>::value)
311   \{
312     ROS\_INFO(\textcolor{stringliteral}{"[StateMachine] life-time constrained smacc signal subscription created. Subscriber is %s"},
313              demangledTypeName<TSmaccObjectType>().c\_str());
314     \hyperlink{classsmacc_1_1ISmaccStateMachine_aaf98bb0edaa5d8c84767e4acfad3548d}{stateCallbackConnections}.push\_back(connection);
315   \}
316   \textcolor{keywordflow}{else}  \textcolor{comment}{// state life-time objects}
317   \{
318     ROS\_WARN(\textcolor{stringliteral}{"[StateMachine] connecting signal to an unknown object with life-time unknown behavior. It
       might provoke "}
319              \textcolor{stringliteral}{"an exception if the object is destroyed during the execution."});
320   \}
321 
322   \textcolor{keywordflow}{return} connection;
323 \}
\end{DoxyCode}
Here is the call graph for this function\+:
\nopagebreak
...
\begin{DoxyCode}
162 \{
163   std::lock\_guard<std::recursive\_mutex> lock(\hyperlink{classsmacc_1_1ISmaccStateMachine_aac785541646e5c517273bf31072505a1}{m\_mutex\_});
164   \textcolor{comment}{// ROS\_WARN("get SM Data lock acquire");}
165   \textcolor{keywordtype}{bool} success = \textcolor{keyword}{false};
166 
167   \textcolor{keywordflow}{if} (!\hyperlink{classsmacc_1_1ISmaccStateMachine_ad2f9dae184ea942db632ac4532a10a91}{globalData\_}.count(name))
168   \{
169     \textcolor{comment}{// ROS\_WARN("get SM Data - data do not exist");}
170     success = \textcolor{keyword}{false};
171   \}
172   \textcolor{keywordflow}{else}
173   \{
174     \textcolor{comment}{// ROS\_WARN("get SM DAta -data exist. accessing");}
175     \textcolor{keywordflow}{try}
176     \{
177       \textcolor{keyword}{auto} &v = \hyperlink{classsmacc_1_1ISmaccStateMachine_ad2f9dae184ea942db632ac4532a10a91}{globalData\_}[name];
178 
179       \textcolor{comment}{// ROS\_WARN("get SM DAta -data exist. any cast");}
180       ret = boost::any\_cast<T>(v.second);
181       success = \textcolor{keyword}{true};
182       \textcolor{comment}{// ROS\_WARN("get SM DAta -data exist. success");}
183     \}
184     \textcolor{keywordflow}{catch} (boost::bad\_any\_cast &ex)
185     \{
186       ROS\_ERROR(\textcolor{stringliteral}{"bad any cast: %s"}, ex.what());
187       success = \textcolor{keyword}{false};
188     \}
189   \}
190 
191   \textcolor{comment}{// ROS\_WARN("get SM Data lock release");}
192   \textcolor{keywordflow}{return} success;
193 \}
\end{DoxyCode}
Here is the caller graph for this function\+:
\nopagebreak
...
227     globalreference = \textcolor{keyword}{dynamic\_cast<}ISmaccClientBehavior *\textcolor{keyword}{>}(behavior);
228 
...
Definition at line 403 of file smacc\+\_\+state\+\_\+machine\+\_\+impl.\+h.


\begin{DoxyCode}
404 \{
405   \textcolor{keywordflow}{for} (\textcolor{keyword}{auto} pair : this->\hyperlink{classsmacc_1_1ISmaccStateMachine_acc5944f313bc6ce1637c632243a511f2}{orthogonals\_})
406   \{
407     \textcolor{comment}{//ROS\_INFO("ortho onruntime configure: %s", pair.second->getName().c\_str());}
408     \textcolor{keyword}{auto} &orthogonal = pair.second;
409     orthogonal->runtimeConfigure();
410   \}
411 
...
\begin{DoxyCode}
368 \{
369   \textcolor{keywordflow}{for} (\textcolor{keyword}{auto} pair : this->\hyperlink{classsmacc_1_1ISmaccStateMachine_acc5944f313bc6ce1637c632243a511f2}{orthogonals\_})
370   \{
371     \textcolor{comment}{//ROS\_INFO("ortho onentry: %s", pair.second->getName().c\_str());}
372     \textcolor{keyword}{auto} &orthogonal = pair.second;
373     \textcolor{keywordflow}{try}
374     \{
375       orthogonal->onEntry();
376     \}
377     \textcolor{keywordflow}{catch} (\textcolor{keyword}{const} std::exception &e)
378     \{
379       ROS\_ERROR(\textcolor{stringliteral}{"[Orthogonal %s] Exception on Entry - continuing with next orthogonal. Exception info: %s"},
380                 pair.second->getName().c\_str(), e.what());
381     \}
382   \}
383 
384   \textcolor{keywordflow}{for} (\textcolor{keyword}{auto} &sr : this->\hyperlink{classsmacc_1_1ISmaccStateMachine_a9c6e7745205bcce80a301f2fbe8f7e99}{currentState\_}->\hyperlink{classsmacc_1_1ISmaccState_acc40f4b3dd02a39242c7e23fe13c3e16}{getStateReactors}())
385   \{
386     \textcolor{keyword}{auto} srname = \hyperlink{namespacesmacc_1_1introspection_a2f495108db3e57604d8d3ff5ef030302}{smacc::demangleSymbol}(\textcolor{keyword}{typeid}(*sr).name()).c\_str();
387     ROS\_INFO(\textcolor{stringliteral}{"state reactor onEntry: %s"}, srname);
388     \textcolor{keywordflow}{try}
389     \{
390       sr->onEntry();
391     \}
392     \textcolor{keywordflow}{catch} (\textcolor{keyword}{const} std::exception &e)
393     \{
394       ROS\_ERROR(\textcolor{stringliteral}{"[State Reactor %s] Exception on Entry - continuing with next state reactor. Exception
       info: %s"},
395                 srname, e.what());
396     \}
397   \}
398 
399   this->\hyperlink{classsmacc_1_1ISmaccStateMachine_ad246a49015fadaeb0b1639d7ab99f7d0}{updateStatusMessage}();
400 \}
\end{DoxyCode}
Here is the call graph for this function\+:
\nopagebreak
...
355 \{
356 std:
357   lock\_guard<std::recursive\_mutex> lock(\hyperlink{classsmacc_1_1ISmaccStateMachine_aac785541646e5c517273bf31072505a1}{m\_mutex\_});
358 
359   ROS\_DEBUG(\textcolor{stringliteral}{"[State Machne] Initializating a new state '%s' and updating current state. Getting state
...
360 
361   \hyperlink{classsmacc_1_1ISmaccStateMachine_ab41ee07d20715142e2f7c92d551b2bd6}{stateSeqCounter\_}++;
362   \hyperlink{classsmacc_1_1ISmaccStateMachine_a9c6e7745205bcce80a301f2fbe8f7e99}{currentState\_} = state;
363   \hyperlink{classsmacc_1_1ISmaccStateMachine_a95e42f735cecdc231ad5372bf9fe7eaf}{currentStateInfo\_} = \hyperlink{classsmacc_1_1ISmaccStateMachine_a0914aa27c3f51374c338d89a32b135d1}{stateMachineInfo\_}->getState<StateType>();
364 \}
\end{DoxyCode}
Here is the call graph for this function\+:
\nopagebreak
...
Definition at line 416 of file smacc\+\_\+state\+\_\+machine\+\_\+impl.\+h.
...
\begin{DoxyCode}
417 \{
418   ROS\_INFO\_STREAM(\textcolor{stringliteral}{"Notification State Exit: leaving state"} << state);
...
420   \{
421     \textcolor{keyword}{auto} &orthogonal = pair.second;
422     \textcolor{keywordflow}{try}
423     \{
424       orthogonal->onExit();
425     \}
426     \textcolor{keywordflow}{catch} (\textcolor{keyword}{const} std::exception &e)
427     \{
428       ROS\_ERROR(\textcolor{stringliteral}{"[Orthogonal %s] Exception onExit - continuing with next orthogonal. Exception info: %s"},
429                 pair.second->getName().c\_str(), e.what());
430     \}
431   \}
432 
433   \textcolor{keywordflow}{for} (\textcolor{keyword}{auto} &sr : state->getStateReactors())
434   \{
435     \textcolor{keyword}{auto} srname = \hyperlink{namespacesmacc_1_1introspection_a2f495108db3e57604d8d3ff5ef030302}{smacc::demangleSymbol}(\textcolor{keyword}{typeid}(*sr).name()).c\_str();
436     ROS\_INFO(\textcolor{stringliteral}{"state reactor OnExit: %s"}, srname);
437     \textcolor{keywordflow}{try}
438     \{
439       sr->onExit();
440     \}
441     \textcolor{keywordflow}{catch} (\textcolor{keyword}{const} std::exception &e)
442     \{
443       ROS\_ERROR(\textcolor{stringliteral}{"[State Reactor %s] Exception on OnExit - continuing with next state reactor. Exception
       info: %s"},
444                 srname, e.what());
445     \}
446   \}
447 
448   \textcolor{keywordflow}{for} (\textcolor{keyword}{auto} &conn : this->\hyperlink{classsmacc_1_1ISmaccStateMachine_aaf98bb0edaa5d8c84767e4acfad3548d}{stateCallbackConnections})
449   \{
450     ROS\_WARN\_STREAM(\textcolor{stringliteral}{"[StateMachine] Disconnecting scoped-lifetime SmaccSignal subscription"});
451     conn.disconnect();
452   \}
453 
454   this->stateCallbackConnections.clear();
455 
456   \hyperlink{classsmacc_1_1ISmaccStateMachine_a9c6e7745205bcce80a301f2fbe8f7e99}{currentState\_} = \textcolor{keyword}{nullptr};
457 \}
\end{DoxyCode}
Here is the call graph for this function\+:
\nopagebreak
...
Definition at line 348 of file smacc\+\_\+state\+\_\+machine\+\_\+impl.\+h.
...
\begin{DoxyCode}
462 \{
463   ROS\_DEBUG(\textcolor{stringliteral}{"PROPAGATING EVENT [%s] TO LUs [%s]: "}, demangleSymbol<EventType>().c\_str(), st->getClassName()
      .c\_str());
464   \textcolor{keywordflow}{for} (\textcolor{keyword}{auto} &sb : st->getStateReactors())
465   \{
466     sb->notifyEvent(ev);
467   \}
468 
469   \textcolor{keyword}{auto} *pst = st->getParentState();
470   \textcolor{keywordflow}{if} (pst != \textcolor{keyword}{nullptr})
471   \{
472     \hyperlink{classsmacc_1_1ISmaccStateMachine_a3d369c7cff22632ca85a8656000ba19c}{propagateEventToStateReactors}(pst, ev);
473   \}
474 \}
\end{DoxyCode}
Here is the call graph for this function\+:
...
100   \{
101     \textcolor{keywordflow}{for} (ISmaccClient *client : ortho->getClients())
102     \{
103       storage = client->getComponent<SmaccComponentType>();
104       \textcolor{keywordflow}{if} (storage == \textcolor{keyword}{nullptr})
105       \{
...
109   \}
110 
111   \textcolor{comment}{// std::string componentkey = demangledTypeName<SmaccComponentType>();}
112   \textcolor{comment}{// SmaccComponentType *ret;}
113 
114   \textcolor{comment}{// auto it = components\_.find(componentkey);}
115 
116   \textcolor{comment}{// if (it == components\_.end())}
117   \textcolor{comment}{// \{}
118   \textcolor{comment}{//     ROS\_DEBUG("%s smacc component is required. Creating a new instance.", componentkey.c\_str());}
119 
120   \textcolor{comment}{//     ret = new SmaccComponentType();}
121   \textcolor{comment}{//     ret->setStateMachine(this);}
122   \textcolor{comment}{//     components\_[componentkey] = static\_cast<smacc::ISmaccComponent *>(ret);}
123   \textcolor{comment}{//     ROS\_DEBUG("%s resource is required. Done.", componentkey.c\_str());}
124   \textcolor{comment}{// \}}
125   \textcolor{comment}{// else}
126   \textcolor{comment}{// \{}
127   \textcolor{comment}{//     ROS\_DEBUG("%s resource is required. Found resource in cache.", componentkey.c\_str());}
128   \textcolor{comment}{//     ret = dynamic\_cast<SmaccComponentType *>(it->second);}
129   \textcolor{comment}{// \}}
130 
131   \textcolor{comment}{// storage = ret;}
132 \}
\end{DoxyCode}
Here is the call graph for this function\+:
\nopagebreak
...
Definition at line 341 of file smacc\+\_\+state\+\_\+machine\+\_\+impl.\+h.
