...
\begin{DoxyCode}
22         : \hyperlink{classsmacc_1_1ISmaccStateMachine_a497c2185584adbec3298d4000277b75e}{ISmaccStateMachine}(signalDetector),
23           sc::asynchronous\_state\_machine<DerivedStateMachine, InitialStateType, SmaccFifoScheduler,
       SmaccAllocator>(ctx)
24     \{
25     \}
\end{DoxyCode}
...
Definition at line 27 of file smacc\+\_\+state\+\_\+machine\+\_\+base.\+h.


\begin{DoxyCode}
28     \{
29         \textcolor{comment}{//updateCurrentState<InitialStateType>(false);}
30     \}
\end{DoxyCode}
...
Definition at line 45 of file smacc\+\_\+state\+\_\+machine\+\_\+base.\+h.


\begin{DoxyCode}
46     \{
47         \hyperlink{classsmacc_1_1ISmaccStateMachine_a3c5aab001d1bb7edcb37413404e4a7c2}{ISmaccStateMachine::EStop}();
48         this->terminate();
49     \}
\end{DoxyCode}
...
Definition at line 51 of file smacc\+\_\+state\+\_\+machine\+\_\+base.\+h.


\begin{DoxyCode}
52     \{
53         ROS\_INFO(\textcolor{stringliteral}{"initiate\_impl"});
54         \textcolor{keyword}{auto} shortname = \hyperlink{namespacesmacc_1_1utils_aacd1975bb7cd9bec4b50e111a2ae7edb}{smacc::utils::cleanShortTypeName}(\textcolor{keyword}{typeid}(
      DerivedStateMachine));
55         this->\hyperlink{classsmacc_1_1ISmaccStateMachine_ae8c9c79ca6cd77c975f5d9cda33a6d5e}{onInitializing}(shortname);
56 
57         ROS\_INFO(\textcolor{stringliteral}{"Introspecting state machine via typeWalker"});
58         \hyperlink{classsmacc_1_1ISmaccStateMachine_a5ec3201cbddab4f062f572fb33021041}{info\_} = std::make\_shared<SmaccStateMachineInfo>();
59         \hyperlink{classsmacc_1_1ISmaccStateMachine_a5ec3201cbddab4f062f572fb33021041}{info\_}->buildStateMachineInfo<InitialStateType>();
60 
61         ROS\_INFO(\textcolor{stringliteral}{"Initializing ROS communication mechanisms"});
62         \hyperlink{classsmacc_1_1ISmaccStateMachine_a5ec3201cbddab4f062f572fb33021041}{info\_}->assembleSMStructureMessage(\textcolor{keyword}{this});
63         this->\hyperlink{classsmacc_1_1ISmaccStateMachine_a95e7f71d0d88fffd0afebb1f9ccdade5}{onInitialized}();
64 
65         ROS\_INFO(\textcolor{stringliteral}{"Initializing state machine"});
...
Definition at line 32 of file smacc\+\_\+state\+\_\+machine\+\_\+base.\+h.


\begin{DoxyCode}
33     \{
34         \hyperlink{classsmacc_1_1ISmaccStateMachine_ae175edef7aba48a1ac82e8401632c5fa}{ISmaccStateMachine::Reset}();
35         this->terminate();
36         smacc::run<DerivedStateMachine>();
37     \}
\end{DoxyCode}
...
\begin{DoxyCode}
40     \{
41         \hyperlink{classsmacc_1_1ISmaccStateMachine_a8f353fcf0686b1dacb57458da882c89b}{ISmaccStateMachine::Stop}();
42         this->terminate();
43     \}
\end{DoxyCode}
