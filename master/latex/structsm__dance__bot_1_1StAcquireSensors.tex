...
References smacc\+::\+Smacc\+State$<$ St\+Acquire\+Sensors, Ms\+Dance\+Bot\+Run\+Mode $>$\+::static\+\_\+create\+State\+Behavior().
...
40 
41       \hyperlink{classsmacc_1_1SmaccState_a827c90e9c0b1791f6ee26f1f074231e4}{static\_createStateBehavior}<SbAllEventsGo,
42                              EvAllGo<SbAllEventsGo, SBehav1>,
...
44 
45       \textcolor{comment}{// auto sball = static\_createStateBehavior<SbAllEventsGo>();}
46       \textcolor{comment}{// sball->enablesOn<EvTopicMessage<CbLidarSensor, OrObstaclePerception>,
       EvTopicMessage<CbConditionTemperatureSensor, OrTemperatureSensor>>();}
47       \textcolor{comment}{// sball->throwsEvent<EvAllGo<SbAllEventsGo, SBehav1>>();}
48    \}
\end{DoxyCode}
