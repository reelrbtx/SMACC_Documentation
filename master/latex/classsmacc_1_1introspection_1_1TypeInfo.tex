...
Referenced by smacc\+::utils\+::clean\+Short\+Type\+Name(), smacc\+::\+I\+Smacc\+Client\+::get\+Type(), get\+Type\+Info\+From\+Type(), and smacc\+::\+Smacc\+State$<$ Most\+Derived, Context, Inner\+Initial, history\+Mode $>$\+::\+Add\+State\+Behavior\+Event\+Type$<$ T\+Transition $>$\+::operator()().
...
Referenced by get\+From\+Std\+Type\+Info(), and smacc\+::\+Smacc\+State$<$ Sti\+S\+Pattern\+Forward3, S\+S $>$\+::static\+\_\+create\+State\+Behavior().
