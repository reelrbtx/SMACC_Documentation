...
Definition at line 7 of file cb\+\_\+absolute\+\_\+rotate.\+cpp.
...
Definition at line 11 of file cb\+\_\+absolute\+\_\+rotate.\+cpp.
...
\begin{DoxyCode}
12 \{
13     this->\hyperlink{classcl__move__base__z_1_1CbAbsoluteRotate_ad5d0e21549940444e1cb525cda73329a}{absoluteGoalAngleDegree} = 
      \hyperlink{classcl__move__base__z_1_1CbAbsoluteRotate_ad5d0e21549940444e1cb525cda73329a}{absoluteGoalAngleDegree};
14 
15     \textcolor{keywordflow}{if} (yaw\_goal\_tolerance >=0)
16     \{
17         this->\hyperlink{classcl__move__base__z_1_1CbAbsoluteRotate_a8d8b5b9c2c821efe101bb07c96c4bdd3}{yawGoalTolerance} = yaw\_goal\_tolerance;
18     \}
19 \}
\end{DoxyCode}
...
90         \}
91         \textcolor{keywordflow}{catch} (tf::TransformException ex)
92         \{
93             ROS\_INFO(\textcolor{stringliteral}{"[CbAbsoluteRotate] Waiting transform: %s"}, ex.what());
94             ros::Duration(1.0).sleep();
95         \}
96     \}
97 
98     ClMoveBaseZ::Goal goal;
99     goal.target\_pose.header.frame\_id = \textcolor{stringliteral}{"/odom"};
100     goal.target\_pose.header.stamp = ros::Time::now();
101 
102     \textcolor{keyword}{auto} currentAngle = tf::getYaw(currentPoseMsg.orientation);
103     \textcolor{keyword}{auto} targetAngle = goal\_angle * M\_PI / 180.0;
104     goal.target\_pose.pose.position = currentPoseMsg.position;
105     goal.target\_pose.pose.orientation = tf::createQuaternionMsgFromYaw(targetAngle);
106 
107     geometry\_msgs::PoseStamped stampedCurrentPoseMsg;
108     stampedCurrentPoseMsg.header.frame\_id = \textcolor{stringliteral}{"/odom"};
109     stampedCurrentPoseMsg.header.stamp = ros::Time::now();
110     stampedCurrentPoseMsg.pose = currentPoseMsg;
111 
112     this->\hyperlink{classsmacc_1_1SmaccClientBehavior_a917f001e763a1059af337bf4e164f542}{requiresClient}(\hyperlink{classcl__move__base__z_1_1CbAbsoluteRotate_a8ddbef73316ff96f30493b28b5627e35}{moveBaseClient\_});
113     \textcolor{keyword}{auto} odomTracker\_ = \hyperlink{classcl__move__base__z_1_1CbAbsoluteRotate_a8ddbef73316ff96f30493b28b5627e35}{moveBaseClient\_}->\hyperlink{classsmacc_1_1ISmaccClient_adef78db601749ca63c19e74a27cb88cc}{getComponent}<odom\_tracker::OdomTracker>
      ();
114     odomTracker\_->pushPath();
115 
116     odomTracker\_->setStartPoint(stampedCurrentPoseMsg);
117     odomTracker\_->setWorkingMode(\hyperlink{namespacecl__move__base__z_1_1odom__tracker_ac46b05813b2791604f6cd0a39ace3ef8a989d06a586bcf9520889228da7faa643}{odom\_tracker::WorkingMode::RECORD\_PATH\_FORWARD}
      );
118 
119     ROS\_INFO\_STREAM(\textcolor{stringliteral}{"current pose: "} << currentPoseMsg);
120     ROS\_INFO\_STREAM(\textcolor{stringliteral}{"goal pose: "} << goal.target\_pose.pose);
121     \hyperlink{classcl__move__base__z_1_1CbAbsoluteRotate_a8ddbef73316ff96f30493b28b5627e35}{moveBaseClient\_}->\hyperlink{classsmacc_1_1client__bases_1_1SmaccActionClientBase_a9c47a5094ac8afb01680307fe5eca922}{sendGoal}(goal);
122 \}
\end{DoxyCode}
...
Definition at line 41 of file cb\+\_\+absolute\+\_\+rotate.\+cpp.
...
\begin{DoxyCode}
42 \{
43     \textcolor{keywordflow}{if}(\hyperlink{classcl__move__base__z_1_1CbAbsoluteRotate_a8d8b5b9c2c821efe101bb07c96c4bdd3}{yawGoalTolerance})
44     \{
45 
46         this->\hyperlink{classcl__move__base__z_1_1CbAbsoluteRotate_aba8d93d615ccd43acd0684f8e88e2209}{setLocalPlannerYawTolerance}(this->
...
Definition at line 21 of file cb\+\_\+absolute\+\_\+rotate.\+cpp.
...
\begin{DoxyCode}
22 \{
23     dynamic\_reconfigure::ReconfigureRequest srv\_req;
24     dynamic\_reconfigure::ReconfigureResponse srv\_resp;
25     dynamic\_reconfigure::Config conf;
26 
27     ros::NodeHandle nh;
28     nh.getParam(\textcolor{stringliteral}{"/move\_base/BackwardLocalPlanner/yaw\_goal\_tolerance"}, this->
      \hyperlink{classcl__move__base__z_1_1CbAbsoluteRotate_a2cfcd2978e7923494e2e66107e134e27}{oldYawTolerance});
29 
30     dynamic\_reconfigure::DoubleParameter yaw\_goal\_tolerance;
31     yaw\_goal\_tolerance.name = \textcolor{stringliteral}{"yaw\_goal\_tolerance"};
32     yaw\_goal\_tolerance.value = newtolerance;
33     conf.doubles.push\_back(yaw\_goal\_tolerance);
34 
35     srv\_req.config = conf;
36     ROS\_INFO(\textcolor{stringliteral}{"updating yaw tolerance local planner to: %lf, from previous value: %lf "}, newtolerance, 
      this->\hyperlink{classcl__move__base__z_1_1CbAbsoluteRotate_a2cfcd2978e7923494e2e66107e134e27}{oldYawTolerance});
37     ros::service::call(\textcolor{stringliteral}{"/move\_base/BackwardLocalPlanner"}, srv\_req, srv\_resp);
38     ros::spinOnce();
39 \}
\end{DoxyCode}
