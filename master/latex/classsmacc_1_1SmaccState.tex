...
\begin{DoxyCode}
50   \{
51     static\_assert(std::is\_base\_of<ISmaccState, Context>::value || std::is\_base\_of<ISmaccStateMachine,
       Context>::value, \textcolor{stringliteral}{"The context class must be a SmaccState or a SmaccStateMachine"});
52 
53     static\_assert(!std::is\_same<MostDerived, Context>::value, \textcolor{stringliteral}{"The context must be a different state or
       state machine than the current state"});
54 
55     ROS\_WARN(\textcolor{stringliteral}{"[%s] creating "}, \hyperlink{smacc__state__base_8h_a0d7815723706a488b5bb65f7e3acf584}{STATE\_NAME});
56     this->set\_context(ctx.pContext\_);
57 
58     this->\hyperlink{classsmacc_1_1ISmaccState_af20df2cfd3aa826fe02a3d703dc63c1b}{stateInfo\_} = \hyperlink{classsmacc_1_1SmaccState_ab7825f5db39dcbee4e4384913026d3e2}{getStateInfo}();
59 
60     \textcolor{comment}{// storing a reference to the parent state}
61     \textcolor{keyword}{auto} &ps = this->\textcolor{keyword}{template} context<Context>();
62     \hyperlink{classsmacc_1_1ISmaccState_ad61db41d8d06a836e7d1dac7767f5695}{parentState\_} = \textcolor{keyword}{dynamic\_cast<}ISmaccState *\textcolor{keyword}{>}(&ps);
63     \hyperlink{classsmacc_1_1SmaccState_a6c40f733c35ddfb9ae2a2f8e9bab07d3}{finishStateThrown} = \textcolor{keyword}{false};
64 
65     this->\hyperlink{classsmacc_1_1ISmaccState_ae59191a663a08489b7d10036f3b25238}{contextNh} = \hyperlink{namespacesmacc_1_1introspection_a8acc3b4146a8b2bb0a9fa4178840e9b9}{optionalNodeHandle}(ctx.pContext\_);
66     ROS\_DEBUG(\textcolor{stringliteral}{"[%s] Ros node handle namespace for this state: %s"}, \hyperlink{smacc__state__base_8h_a0d7815723706a488b5bb65f7e3acf584}{STATE\_NAME}, 
      \hyperlink{classsmacc_1_1ISmaccState_ae59191a663a08489b7d10036f3b25238}{contextNh}.getNamespace().c\_str());
67     \textcolor{keywordflow}{if} (\hyperlink{classsmacc_1_1ISmaccState_ae59191a663a08489b7d10036f3b25238}{contextNh}.getNamespace() == \textcolor{stringliteral}{"/"})
68     \{
69       \textcolor{keyword}{auto} nhname = \hyperlink{namespacesmacc_1_1utils_aacd1975bb7cd9bec4b50e111a2ae7edb}{smacc::utils::cleanShortTypeName}(\textcolor{keyword}{typeid}(Context));
70       ROS\_INFO(\textcolor{stringliteral}{"[%s] Creating ros NodeHandle for this state: %s"}, \hyperlink{smacc__state__base_8h_a0d7815723706a488b5bb65f7e3acf584}{STATE\_NAME}, nhname.c\_str());
71       \hyperlink{classsmacc_1_1ISmaccState_ae59191a663a08489b7d10036f3b25238}{contextNh} = ros::NodeHandle(nhname);
72     \}
73   \}
\end{DoxyCode}
...
\begin{DoxyCode}
179   \{
180     \textcolor{keyword}{auto} strorthogonal = \hyperlink{namespacesmacc_1_1introspection_a2f495108db3e57604d8d3ff5ef030302}{demangleSymbol}(\textcolor{keyword}{typeid}(TOrthogonal).name()).c\_str();
181     \textcolor{keyword}{auto} strbehavior = \hyperlink{namespacesmacc_1_1introspection_a2f495108db3e57604d8d3ff5ef030302}{demangleSymbol}(\textcolor{keyword}{typeid}(TBehavior).name()).c\_str();
182 
183     ROS\_INFO(\textcolor{stringliteral}{"[%s] Runtime configure orthogonal %s -> %s"}, \hyperlink{smacc__state__base_8h_a0d7815723706a488b5bb65f7e3acf584}{STATE\_NAME}, strorthogonal, strbehavior
      );
184 
...
298 
299     \textcolor{keyword}{auto} classname = \hyperlink{namespacesmacc_1_1utils_aacd1975bb7cd9bec4b50e111a2ae7edb}{smacc::utils::cleanShortTypeName}(\textcolor{keyword}{typeid}(MostDerived)).
      c\_str();
300 
301     \textcolor{comment}{// TODO: make this static to build the parameter tree at startup}
302     this->\hyperlink{classsmacc_1_1ISmaccState_a13fe6e6abfdb87996402189d44b78494}{nh} = ros::NodeHandle(\hyperlink{classsmacc_1_1ISmaccState_ae59191a663a08489b7d10036f3b25238}{contextNh}.getNamespace() + std::string(\textcolor{stringliteral}{"/"}) + classname);
303 
304     ROS\_DEBUG(\textcolor{stringliteral}{"[%s] nodehandle namespace: %s"}, \hyperlink{smacc__state__base_8h_a0d7815723706a488b5bb65f7e3acf584}{STATE\_NAME}, \hyperlink{classsmacc_1_1ISmaccState_a13fe6e6abfdb87996402189d44b78494}{nh}.getNamespace().c\_str());
305 
306     this->\hyperlink{classsmacc_1_1ISmaccState_a0b6c531ca8c446052022308548f55b92}{setParam}(\textcolor{stringliteral}{"created"}, \textcolor{keyword}{true});
307 
308     \textcolor{comment}{// before dynamic runtimeConfigure, we execute the staticConfigure behavior configurations}
309     \{
310       ROS\_INFO(\textcolor{stringliteral}{"[%s] -- STATIC STATE DESCRIPTION --"}, \hyperlink{smacc__state__base_8h_a0d7815723706a488b5bb65f7e3acf584}{STATE\_NAME});
311 
312       \textcolor{keywordflow}{for} (\textcolor{keyword}{const} \textcolor{keyword}{auto} &stateReactorsVector : \hyperlink{classsmacc_1_1introspection_1_1SmaccStateInfo_ad3d8b3450060cb0b91f38fb2fe0a7678}{SmaccStateInfo::staticBehaviorInfo}
      )
313       \{
314         ROS\_DEBUG(\textcolor{stringliteral}{"[%s] state info: %s"}, \hyperlink{smacc__state__base_8h_a0d7815723706a488b5bb65f7e3acf584}{STATE\_NAME},  \hyperlink{namespacesmacc_1_1introspection_a2f495108db3e57604d8d3ff5ef030302}{demangleSymbol}(
      stateReactorsVector.first->name()).c\_str());
315         \textcolor{keywordflow}{for} (\textcolor{keyword}{auto} &bhinfo : stateReactorsVector.second)
316         \{
317           ROS\_DEBUG(\textcolor{stringliteral}{"[%s] client behavior: %s"}, \hyperlink{smacc__state__base_8h_a0d7815723706a488b5bb65f7e3acf584}{STATE\_NAME},  
...
319       \}
320 
321       \textcolor{keyword}{const} std::type\_info *tindex = &(\textcolor{keyword}{typeid}(MostDerived));
322       \textcolor{keyword}{auto} &staticDefinedBehaviors = SmaccStateInfo::staticBehaviorInfo[tindex];
323       \textcolor{keyword}{auto} &staticDefinedStateReactors = \hyperlink{classsmacc_1_1introspection_1_1SmaccStateInfo_abd1d6ca5060c87f6bd11fde3e5b2ac4d}{SmaccStateInfo::stateReactorsInfo}
      [tindex];
324 
325       \textcolor{keywordflow}{for} (\textcolor{keyword}{auto} &bhinfo : staticDefinedBehaviors)
326       \{
327         ROS\_INFO(\textcolor{stringliteral}{"[%s] Creating static client behavior: %s"}, \hyperlink{smacc__state__base_8h_a0d7815723706a488b5bb65f7e3acf584}{STATE\_NAME}, 
      \hyperlink{namespacesmacc_1_1introspection_a2f495108db3e57604d8d3ff5ef030302}{demangleSymbol}(bhinfo.behaviorType->name()).c\_str());
328         bhinfo.factoryFunction(\textcolor{keyword}{this});
329       \}
330 
331       \textcolor{keywordflow}{for} (\textcolor{keyword}{auto} &sr : staticDefinedStateReactors)
332       \{
333         ROS\_INFO(\textcolor{stringliteral}{"[%s] Creating static state reactor: %s"}, \hyperlink{smacc__state__base_8h_a0d7815723706a488b5bb65f7e3acf584}{STATE\_NAME},  
...
334         sr->factoryFunction(\textcolor{keyword}{this});
335       \}
336 
337       ROS\_INFO(\textcolor{stringliteral}{"[%s] ---- END STATIC DESCRIPTION"}, \hyperlink{smacc__state__base_8h_a0d7815723706a488b5bb65f7e3acf584}{STATE\_NAME});
338     \}
339 
340     ROS\_INFO(\textcolor{stringliteral}{"[%s] State runtime configuration"}, \hyperlink{smacc__state__base_8h_a0d7815723706a488b5bb65f7e3acf584}{STATE\_NAME});
341 
342     \textcolor{comment}{// first we runtime configure the state, where we create client behaviors}
343     \textcolor{keyword}{static\_cast<}MostDerived *\textcolor{keyword}{>}(\textcolor{keyword}{this})->\hyperlink{classsmacc_1_1SmaccState_a6995704a0232e24f4c38250302c0a01f}{runtimeConfigure}();
344 
345     \textcolor{comment}{// second the orthogonals are internally configured}
346     this->\hyperlink{classsmacc_1_1SmaccState_afc39f8e0ca4001b2159a100da2fccd0e}{getStateMachine}().\hyperlink{classsmacc_1_1ISmaccStateMachine_a7377ca0f79289fdc27f9ed3ff6e67263}{notifyOnRuntimeConfigured}(
      static\_cast<MostDerived *>(\textcolor{keyword}{this}));
347 
348     ROS\_INFO(\textcolor{stringliteral}{"[%s] State OnEntry"}, \hyperlink{smacc__state__base_8h_a0d7815723706a488b5bb65f7e3acf584}{STATE\_NAME});
349 
350     \textcolor{comment}{// finally we go to the derived state onEntry Function}
351     \textcolor{keyword}{static\_cast<}MostDerived *\textcolor{keyword}{>}(\textcolor{keyword}{this})->\hyperlink{classsmacc_1_1SmaccState_a4a10a74fdbe51a798b8d651668b8ed9a}{onEntry}();
352     ROS\_INFO(\textcolor{stringliteral}{"[%s] State OnEntry code finished"}, \hyperlink{smacc__state__base_8h_a0d7815723706a488b5bb65f7e3acf584}{STATE\_NAME});
353 
...
Definition at line 94 of file smacc\+\_\+state\+\_\+base.\+h.
...
Definition at line 99 of file smacc\+\_\+state\+\_\+base.\+h.
