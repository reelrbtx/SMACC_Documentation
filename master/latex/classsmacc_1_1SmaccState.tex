...
\begin{DoxyCode}
256   \{
257     \textcolor{keyword}{auto} sbh = std::make\_shared<smacc::introspection::StateReactorHandler>();
258 
259     \textcolor{keyword}{auto} sbinfo = std::make\_shared<SmaccStateReactorInfo>();
260     sbinfo->stateReactorType = &\textcolor{keyword}{typeid}(TStateReactor);
261     sbinfo->sbh = sbh;
...
265 
266     \textcolor{keywordflow}{if} (!\hyperlink{classsmacc_1_1introspection_1_1SmaccStateInfo_abd1d6ca5060c87f6bd11fde3e5b2ac4d}{SmaccStateInfo::stateReactorsInfo}.count(tindex))
267       \hyperlink{classsmacc_1_1introspection_1_1SmaccStateInfo_abd1d6ca5060c87f6bd11fde3e5b2ac4d}{SmaccStateInfo::stateReactorsInfo}[tindex] = std::vector<
...
270       \textcolor{keyword}{auto} sb = state->createStateReactor<TStateReactor>(\hyperlink{namespacegenerate__debs_a75f9143e38df82d83b2e8a6f99cae02c}{args}...);
271       sbh->configureStateReactor(sb);
272       sb->initialize(state);
273       \textcolor{keywordflow}{return} sb;
274     \};
275 
276     \hyperlink{classsmacc_1_1introspection_1_1SmaccStateInfo_abd1d6ca5060c87f6bd11fde3e5b2ac4d}{SmaccStateInfo::stateReactorsInfo}[tindex].push\_back(sbinfo);
277 
