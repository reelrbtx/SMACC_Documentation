...
Definition at line 304 of file smacc\+\_\+state\+\_\+base.\+h.
...
159     \{
160       this->\hyperlink{classsmacc_1_1SmaccState_afc39f8e0ca4001b2159a100da2fccd0e}{getStateMachine}().\hyperlink{classsmacc_1_1ISmaccStateMachine_a5c8d4c9a4b11c7950266a00e48080ce3}{lockStateMachine}(\textcolor{stringliteral}{"state exit"});
161       \textcolor{keyword}{auto} fullname = \hyperlink{namespacesmacc_1_1introspection_a2f495108db3e57604d8d3ff5ef030302}{demangleSymbol}(\textcolor{keyword}{typeid}(MostDerived).name());
162       ROS\_WARN\_STREAM(\textcolor{stringliteral}{"exiting state: "} << fullname);
163       this->\hyperlink{classsmacc_1_1ISmaccState_a0b6c531ca8c446052022308548f55b92}{setParam}(\textcolor{stringliteral}{"destroyed"}, \textcolor{keyword}{true});
164 
165       this->\hyperlink{classsmacc_1_1SmaccState_afc39f8e0ca4001b2159a100da2fccd0e}{getStateMachine}().\hyperlink{classsmacc_1_1ISmaccStateMachine_a9d2bd4aca0c80a1ec22c5f95e7c38db8}{notifyOnStateExit}(static\_cast<MostDerived *>(\textcolor{keyword}{
      this}));
166       ROS\_WARN\_STREAM(\textcolor{stringliteral}{"state exit: "} << fullname);
167     \}
168     \textcolor{keywordflow}{catch} (...)
169     \{
170     \}
171     this->\hyperlink{classsmacc_1_1SmaccState_afc39f8e0ca4001b2159a100da2fccd0e}{getStateMachine}().\hyperlink{classsmacc_1_1ISmaccStateMachine_ae2e3ceb87bfe3f9d8bf320e36071fdc7}{unlockStateMachine}(\textcolor{stringliteral}{"state exit"});
172   \}
\end{DoxyCode}
...
\begin{DoxyCode}
280   \{
281     \textcolor{keyword}{auto} *thisobject = \textcolor{keyword}{static\_cast<}MostDerived *\textcolor{keyword}{>}(\textcolor{keyword}{this});
282     \textcolor{keyword}{auto} condition = boost::bind(conditionFn, thisobject);
283     \textcolor{keywordtype}{bool} conditionResult = condition();
284     \textcolor{comment}{//ROS\_INFO("LOOP EVENT CONDITION: %d", conditionResult);}
285     \textcolor{keywordflow}{if} (conditionResult)
286     \{
287       \textcolor{keyword}{auto} evloopcontinue = \textcolor{keyword}{new} \hyperlink{structsmacc_1_1default__events_1_1EvLoopContinue}{EvLoopContinue<MostDerived>}();
288       this->\hyperlink{classsmacc_1_1ISmaccState_acef404ab3766ddf2892e8dad14a4a7cf}{postEvent}(evloopcontinue);
289     \}
290     \textcolor{keywordflow}{else}
291     \{
292       \textcolor{keyword}{auto} evloopend = \textcolor{keyword}{new} \hyperlink{structsmacc_1_1default__events_1_1EvLoopEnd}{EvLoopEnd<MostDerived>}();
293       this->\hyperlink{classsmacc_1_1ISmaccState_acef404ab3766ddf2892e8dad14a4a7cf}{postEvent}(evloopend);
294     \}
295     ROS\_INFO(\textcolor{stringliteral}{"POST THROW CONDITION"});
296   \}
\end{DoxyCode}
...
\begin{DoxyCode}
230   \{
231     \textcolor{keyword}{auto} strorthogonal = \hyperlink{namespacesmacc_1_1introspection_a2f495108db3e57604d8d3ff5ef030302}{demangleSymbol}(\textcolor{keyword}{typeid}(TOrthogonal).name());
232     \textcolor{keyword}{auto} strbehavior = \hyperlink{namespacesmacc_1_1introspection_a2f495108db3e57604d8d3ff5ef030302}{demangleSymbol}(\textcolor{keyword}{typeid}(TBehavior).name());
233 
234     ROS\_INFO\_STREAM(\textcolor{stringliteral}{"Orthogonal "} << strorthogonal << \textcolor{stringliteral}{" -> "} << strbehavior);
235 
236     \hyperlink{structsmacc_1_1introspection_1_1ClientBehaviorInfoEntry}{ClientBehaviorInfoEntry} bhinfo;
237     bhinfo.\hyperlink{structsmacc_1_1introspection_1_1ClientBehaviorInfoEntry_abb0863623802e0107c659e61931518f4}{factoryFunction} = [=](ISmaccState *state) \{
238       \textcolor{comment}{//auto bh = std::make\_shared<TBehavior>(args...);}
239       state->configure<TOrthogonal, TBehavior>(\hyperlink{namespacegenerate__debs_a75f9143e38df82d83b2e8a6f99cae02c}{args}...);
240     \};
241 
242     bhinfo.behaviorType = &(\textcolor{keyword}{typeid}(TBehavior));
243     bhinfo.orthogonalType = &(\textcolor{keyword}{typeid}(TOrthogonal));
244 
245     \textcolor{keyword}{const} std::type\_info *tindex = &(\textcolor{keyword}{typeid}(MostDerived));
246     \textcolor{keywordflow}{if} (!\hyperlink{classsmacc_1_1introspection_1_1SmaccStateInfo_ad3d8b3450060cb0b91f38fb2fe0a7678}{SmaccStateInfo::staticBehaviorInfo}.count(tindex))
247       \hyperlink{classsmacc_1_1introspection_1_1SmaccStateInfo_ad3d8b3450060cb0b91f38fb2fe0a7678}{SmaccStateInfo::staticBehaviorInfo}[tindex] = 
      std::vector<ClientBehaviorInfoEntry>();
248 
249     \hyperlink{classsmacc_1_1introspection_1_1SmaccStateInfo_ad3d8b3450060cb0b91f38fb2fe0a7678}{SmaccStateInfo::staticBehaviorInfo}[tindex].push\_back(bhinfo);
250   \}
\end{DoxyCode}
...
Definition at line 316 of file smacc\+\_\+state\+\_\+base.\+h.


\begin{DoxyCode}
319   \{
320     \textcolor{keyword}{const} \hyperlink{classsmacc_1_1SmaccState_a65a772c2e2039e9a59148ba6ffb54d8a}{inner\_context\_ptr\_type} pInnerContext(
321         \hyperlink{classsmacc_1_1SmaccState_a1dccb401e1a99031863a21a590d953e6}{shallow\_construct}(pContext, outermostContextBase));
322     base\_type::template deep\_construct\_inner<inner\_initial\_list>(
323         pInnerContext, outermostContextBase);
324   \}
\end{DoxyCode}
...
\begin{DoxyCode}
147   \{
148     \textcolor{keywordflow}{return} \hyperlink{namespacesmacc_1_1introspection_a2f495108db3e57604d8d3ff5ef030302}{demangleSymbol}(\textcolor{keyword}{typeid}(MostDerived).name());
149   \}
\end{DoxyCode}
...
\begin{DoxyCode}
206   \{
207     \textcolor{keywordflow}{return} base\_type::outermost\_context().getGlobalSMData(name, ret);
208   \}
\end{DoxyCode}
...
\begin{DoxyCode}
152   \{
153     \textcolor{keywordflow}{return} \hyperlink{namespacesmacc_1_1utils_aacd1975bb7cd9bec4b50e111a2ae7edb}{smacc::utils::cleanShortTypeName}(\textcolor{keyword}{typeid}(MostDerived));
154   \}
\end{DoxyCode}
...
\begin{DoxyCode}
224   \{
225     \textcolor{keywordflow}{return} base\_type::outermost\_context();
226   \}
\end{DoxyCode}
...
\begin{DoxyCode}
311   \{
312     \hyperlink{classsmacc_1_1SmaccState_aac23d8a6909f75c5e5fca2a7c09b5368}{deep\_construct}(&outermostContextBase, outermostContextBase);
313   \}
\end{DoxyCode}
...
\begin{DoxyCode}
219   \{
220     base\_type::outermost\_context().requiresComponent(storage);
221   \}
\end{DoxyCode}
...
\begin{DoxyCode}
213   \{
214     base\_type::outermost\_context().setGlobalSMData(name, value);
215   \}
\end{DoxyCode}
...
\begin{DoxyCode}
329   \{
330     \textcolor{keyword}{const} \hyperlink{classsmacc_1_1SmaccState_a65a772c2e2039e9a59148ba6ffb54d8a}{inner\_context\_ptr\_type} pInnerContext(
331 
332         \textcolor{keyword}{new} MostDerived(
333             \hyperlink{classSmaccState}{SmaccState<MostDerived, Context, InnerInitial, historyMode>}
      ::
334 
335                 \hyperlink{common_8h_af2dcacead80d69b96952496fe413bbfe}{my\_context}(pContext)));
336     outermostContextBase.add(pInnerContext);
337     \textcolor{keywordflow}{return} pInnerContext;
338   \}
\end{DoxyCode}
...
Definition at line 253 of file smacc\+\_\+state\+\_\+base.\+h.


\begin{DoxyCode}
254   \{
255     \textcolor{keyword}{auto} sbh = std::make\_shared<smacc::introspection::StateBehaviorHandler>();
256 
257     \textcolor{keyword}{auto} sbinfo = std::make\_shared<SmaccStateBehaviorInfo>();
258     sbinfo->stateBehaviorType = &\textcolor{keyword}{typeid}(TStateBehavior);
259     sbinfo->sbh = sbh;
260     sbh->sbInfo\_ = sbinfo;
261 
262     \textcolor{keyword}{const} std::type\_info *tindex = &(\textcolor{keyword}{typeid}(MostDerived)); \textcolor{comment}{// get identifier of the current state}
263 
264     \textcolor{keywordflow}{if} (!\hyperlink{classsmacc_1_1introspection_1_1SmaccStateInfo_a9366c579e8cbe2b842b2dcc9fc7154de}{SmaccStateInfo::stateBehaviorsInfo}.count(tindex))
265       \hyperlink{classsmacc_1_1introspection_1_1SmaccStateInfo_a9366c579e8cbe2b842b2dcc9fc7154de}{SmaccStateInfo::stateBehaviorsInfo}[tindex] = std::vector<
      std::shared\_ptr<SmaccStateBehaviorInfo>>();
266 
267     sbinfo->factoryFunction = [&, sbh, \hyperlink{namespacegenerate__debs_a75f9143e38df82d83b2e8a6f99cae02c}{args}...](ISmaccState *state) \{
268       \textcolor{keyword}{auto} sb = state->createStateBehavior<TStateBehavior>(\hyperlink{namespacegenerate__debs_a75f9143e38df82d83b2e8a6f99cae02c}{args}...);
269       sbh->configureStateBehavior(sb);
270       sb->initialize(state);
271       \textcolor{keywordflow}{return} sb;
272     \};
273 
274     \hyperlink{classsmacc_1_1introspection_1_1SmaccStateInfo_a9366c579e8cbe2b842b2dcc9fc7154de}{SmaccStateInfo::stateBehaviorsInfo}[tindex].push\_back(sbinfo);
275 
276     \textcolor{keywordflow}{return} sbh;
277   \}
\end{DoxyCode}
...
\begin{DoxyCode}
175   \{
176     \textcolor{keywordflow}{if} (!\hyperlink{classsmacc_1_1SmaccState_a6c40f733c35ddfb9ae2a2f8e9bab07d3}{finishStateThrown})
177     \{
178       \textcolor{keyword}{auto} *finishEvent = \textcolor{keyword}{new} \hyperlink{structsmacc_1_1default__events_1_1EvStateFinish}{EvStateFinish<MostDerived>}();
179       finishEvent->\hyperlink{structsmacc_1_1default__events_1_1EvStateFinish_ad598cccf2b8ddb507f3c0efba2232d62}{state} = \textcolor{keyword}{static\_cast<}MostDerived *\textcolor{keyword}{>}(\textcolor{keyword}{this});
180       this->\hyperlink{classsmacc_1_1ISmaccState_acef404ab3766ddf2892e8dad14a4a7cf}{postEvent}(finishEvent);
181       \hyperlink{classsmacc_1_1SmaccState_a6c40f733c35ddfb9ae2a2f8e9bab07d3}{finishStateThrown} = \textcolor{keyword}{true};
182     \}
183   \}
\end{DoxyCode}
