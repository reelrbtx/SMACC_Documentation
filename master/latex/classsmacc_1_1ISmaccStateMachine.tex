...
Definition at line 409 of file smacc\+\_\+state\+\_\+machine\+\_\+impl.\+h.


\begin{DoxyCode}
410 \{
411     this->\hyperlink{classsmacc_1_1ISmaccStateMachine_a0914aa27c3f51374c338d89a32b135d1}{stateMachineInfo\_} = std::make\_shared<SmaccStateMachineInfo>();
412     this->\hyperlink{classsmacc_1_1ISmaccStateMachine_a0914aa27c3f51374c338d89a32b135d1}{stateMachineInfo\_}->buildStateMachineInfo<InitialStateType>();
413     this->\hyperlink{classsmacc_1_1ISmaccStateMachine_a0914aa27c3f51374c338d89a32b135d1}{stateMachineInfo\_}->assembleSMStructureMessage(\textcolor{keyword}{this});
414     this->\hyperlink{classsmacc_1_1ISmaccStateMachine_af34fa8346ae3f52882704422d59b9055}{checkStateMachineConsistence}();
415 \}
\end{DoxyCode}
...
Referenced by ros\+\_\+timer\+\_\+client\+::\+Cb\+Timer\+Countdown\+Once\+::on\+Timer\+Tick(), and ros\+\_\+timer\+\_\+client\+::\+Cb\+Timer\+Countdown\+Loop\+::on\+Timer\+Tick().
...
292 
293     if (std::is\_base\_of<ISmaccComponent, TSmaccObjectType>::value)
294     \{
295     \}
296     \textcolor{keywordflow}{else} \textcolor{comment}{// state life-time objects}
297     \{
298         ROS\_INFO(\textcolor{stringliteral}{"[StateMachine] life-time constrained smacc signal subscription created. Subscriber is %s"}
      , demangledTypeName<TSmaccObjectType>().c\_str());
299         \hyperlink{classsmacc_1_1ISmaccStateMachine_aaf98bb0edaa5d8c84767e4acfad3548d}{stateCallbackConnections}.push\_back(connection);
300     \}
301     \textcolor{keywordflow}{return} connection;
302 \}
\end{DoxyCode}
...
\begin{DoxyCode}
306 \{
307     \textcolor{keywordflow}{return} signal.connect(callback);
308     \textcolor{comment}{// return signal;}
309 \}
\end{DoxyCode}
...
\begin{DoxyCode}
423 \{
424     \textcolor{keywordflow}{return} this->\hyperlink{classsmacc_1_1ISmaccStateMachine_a9c6e7745205bcce80a301f2fbe8f7e99}{currentState\_};
425 \}
\end{DoxyCode}
...
\begin{DoxyCode}
418 \{
419     \textcolor{keywordflow}{return} this->\hyperlink{classsmacc_1_1ISmaccStateMachine_ab41ee07d20715142e2f7c92d551b2bd6}{stateSeqCounter\_};
420 \}
\end{DoxyCode}
...
Definition at line 312 of file smacc\+\_\+state\+\_\+machine\+\_\+impl.\+h.


\begin{DoxyCode}
313 \{
314     \textcolor{keywordflow}{return} \hyperlink{classsmacc_1_1ISmaccStateMachine_ad8877bcca9dbb345fe72cca839c93dd3}{nh\_}.getParam(param\_name, param\_storage);
315 \}
\end{DoxyCode}
...
Definition at line 427 of file smacc\+\_\+state\+\_\+machine\+\_\+impl.\+h.


\begin{DoxyCode}
428 \{
429     \textcolor{keywordflow}{return} *this->\hyperlink{classsmacc_1_1ISmaccStateMachine_a0914aa27c3f51374c338d89a32b135d1}{stateMachineInfo\_};
430 \}
\end{DoxyCode}
...
Definition at line 358 of file smacc\+\_\+state\+\_\+machine\+\_\+impl.\+h.


\begin{DoxyCode}
359 \{
360     \textcolor{keywordflow}{for} (\textcolor{keyword}{auto} pair : this->\hyperlink{classsmacc_1_1ISmaccStateMachine_a6d7c344ce2570b35737a1173633d0d71}{orthogonals\_})
361     \{
362         ROS\_INFO(\textcolor{stringliteral}{"ortho onruntime configure: %s"}, pair.second->getName().c\_str());
363         \textcolor{keyword}{auto} &orthogonal = pair.second;
364         orthogonal->runtimeConfigure();
365     \}
366 
367     this->\hyperlink{classsmacc_1_1ISmaccStateMachine_ad246a49015fadaeb0b1639d7ab99f7d0}{updateStatusMessage}();
368 \}
\end{DoxyCode}
...
Definition at line 345 of file smacc\+\_\+state\+\_\+machine\+\_\+impl.\+h.


\begin{DoxyCode}
346 \{
347     \textcolor{keywordflow}{for} (\textcolor{keyword}{auto} pair : this->\hyperlink{classsmacc_1_1ISmaccStateMachine_a6d7c344ce2570b35737a1173633d0d71}{orthogonals\_})
348     \{
349         ROS\_INFO(\textcolor{stringliteral}{"ortho onentry: %s"}, pair.second->getName().c\_str());
350         \textcolor{keyword}{auto} &orthogonal = pair.second;
351         orthogonal->onEntry();
352     \}
353 
354     this->\hyperlink{classsmacc_1_1ISmaccStateMachine_ad246a49015fadaeb0b1639d7ab99f7d0}{updateStatusMessage}();
355 \}
\end{DoxyCode}
...
Definition at line 332 of file smacc\+\_\+state\+\_\+machine\+\_\+impl.\+h.


\begin{DoxyCode}
333 \{
334 std:
335     lock\_guard<std::recursive\_mutex> lock(\hyperlink{classsmacc_1_1ISmaccStateMachine_aac785541646e5c517273bf31072505a1}{m\_mutex\_});
336 
337     ROS\_INFO\_STREAM(\textcolor{stringliteral}{"Notification State Entry, orthogonals:"} << this->
...
338 
339     \hyperlink{classsmacc_1_1ISmaccStateMachine_ab41ee07d20715142e2f7c92d551b2bd6}{stateSeqCounter\_}++;
340     \hyperlink{classsmacc_1_1ISmaccStateMachine_a9c6e7745205bcce80a301f2fbe8f7e99}{currentState\_} = state;
341     \hyperlink{classsmacc_1_1ISmaccStateMachine_a95e42f735cecdc231ad5372bf9fe7eaf}{currentStateInfo\_} = \hyperlink{classsmacc_1_1ISmaccStateMachine_a0914aa27c3f51374c338d89a32b135d1}{stateMachineInfo\_}->getState<StateType>();
342 \}
\end{DoxyCode}
...
Definition at line 371 of file smacc\+\_\+state\+\_\+machine\+\_\+impl.\+h.


\begin{DoxyCode}
372 \{
373     ROS\_INFO\_STREAM(\textcolor{stringliteral}{"Notification State Exit: leaving state"} << state);
374     \textcolor{keywordflow}{for} (\textcolor{keyword}{auto} pair : this->\hyperlink{classsmacc_1_1ISmaccStateMachine_a6d7c344ce2570b35737a1173633d0d71}{orthogonals\_})
375     \{
376         \textcolor{keyword}{auto} &orthogonal = pair.second;
377         orthogonal->onExit();
378     \}
379 
380     \textcolor{keywordflow}{for} (\textcolor{keyword}{auto} &conn : this->\hyperlink{classsmacc_1_1ISmaccStateMachine_aaf98bb0edaa5d8c84767e4acfad3548d}{stateCallbackConnections})
381     \{
382         ROS\_WARN\_STREAM(\textcolor{stringliteral}{"[StateMachine] Disconnecting scoped-lifetime SmaccSignal subscription"});
383         conn.disconnect();
384     \}
385 
386     this->stateCallbackConnections.clear();
387 
388     \hyperlink{classsmacc_1_1ISmaccStateMachine_a9c6e7745205bcce80a301f2fbe8f7e99}{currentState\_} = \textcolor{keyword}{nullptr};
389 \}
\end{DoxyCode}
...
Definition at line 326 of file smacc\+\_\+state\+\_\+machine\+\_\+impl.\+h.


\begin{DoxyCode}
327 \{
328     \textcolor{keywordflow}{return} \hyperlink{classsmacc_1_1ISmaccStateMachine_ad8877bcca9dbb345fe72cca839c93dd3}{nh\_}.param(param\_name, param\_val, default\_val);
329 \}
\end{DoxyCode}
...
Definition at line 393 of file smacc\+\_\+state\+\_\+machine\+\_\+impl.\+h.
...
\begin{DoxyCode}
394 \{
395     ROS\_DEBUG(\textcolor{stringliteral}{"PROPAGATING EVENT [%s] TO LUs [%s]: "}, demangleSymbol<EventType>().c\_str(), st->getClassName
      ().c\_str());
396     \textcolor{keywordflow}{for} (\textcolor{keyword}{auto} &sb : st->getStateReactors())
397     \{
398         sb->notifyEvent(ev);
399     \}
400 
401     \textcolor{keyword}{auto} *pst = st->getParentState();
402     \textcolor{keywordflow}{if} (pst != \textcolor{keyword}{nullptr})
403     \{
404         \hyperlink{classsmacc_1_1ISmaccStateMachine_a3d369c7cff22632ca85a8656000ba19c}{propagateEventToStateReactors}(pst, ev);
405     \}
406 \}
\end{DoxyCode}
...
Definition at line 319 of file smacc\+\_\+state\+\_\+machine\+\_\+impl.\+h.


\begin{DoxyCode}
320 \{
321     \textcolor{keywordflow}{return} \hyperlink{classsmacc_1_1ISmaccStateMachine_ad8877bcca9dbb345fe72cca839c93dd3}{nh\_}.setParam(param\_name, param\_val);
322 \}
\end{DoxyCode}
