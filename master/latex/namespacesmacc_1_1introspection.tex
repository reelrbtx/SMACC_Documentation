...
\item 
struct \hyperlink{structsmacc_1_1introspection_1_1EventGeneratorCallbackFunctor}{Event\+Generator\+Callback\+Functor}
\item 
class \hyperlink{classsmacc_1_1introspection_1_1EventGeneratorHandler}{Event\+Generator\+Handler}
\item 
...
\item 
struct \hyperlink{structsmacc_1_1introspection_1_1SmaccEventGeneratorInfo}{Smacc\+Event\+Generator\+Info}
\item 
...
\item 
struct \hyperlink{structsmacc_1_1introspection_1_1StateReactorCallbackFunctor}{State\+Reactor\+Callback\+Functor}
\item 
...
\item 
std\+::string \hyperlink{namespacesmacc_1_1introspection_a1fdcabf57e4277cd66c46522531e35fa}{replace\+\_\+back} (std\+::string roottype, std\+::vector$<$ std\+::pair$<$ std\+::string, std\+::string $>$$>$ \&orderedtypesdict)
\end{DoxyCompactItemize}
...
Definition at line 129 of file smacc\+\_\+state\+\_\+info.\+h.


\begin{DoxyCode}
130 \{
131     \hyperlink{namespacesmacc_1_1introspection_a710cf406873961567c11027582c7f720a4da54a31b31f1c863864fdee05fc35c8}{SUPERSTATE} = 2,
132     \hyperlink{namespacesmacc_1_1introspection_a710cf406873961567c11027582c7f720a2b848a8cc886d253d21a77c43cd50aae}{STATE} = 1,
133     \hyperlink{namespacesmacc_1_1introspection_a710cf406873961567c11027582c7f720a6d39c20504d2f2afe9c8c27351e61d20}{SUPERSTATE\_ROUTINE} = 1
134 \};
\end{DoxyCode}
...
Definition at line 353 of file smacc\+\_\+state\+\_\+machine\+\_\+info.\+h.
...
Referenced by smacc\+::introspection\+::\+State\+Reactor\+Handler\+::add\+Input\+Event(), smacc\+::\+Orthogonal$<$ Or\+Service3 $>$\+::create\+Client(), smacc\+::\+Signal\+Detector\+::find\+Updatable\+Clients(), smacc\+::\+Signal\+Detector\+::find\+Updatable\+State\+Elements(), smacc\+::client\+\_\+bases\+::\+Smacc\+Action\+Client\+Base$<$ sm\+\_\+dance\+\_\+bot\+::\+L\+E\+D\+Control\+Action $>$\+::on\+Orthogonal\+Allocation(), smacc\+::\+Signal\+Detector\+::poll\+Once(), and smacc\+::introspection\+::\+State\+Reactor\+Handler\+::set\+Output\+Event().
...
Definition at line 140 of file smacc\+\_\+state\+\_\+machine\+\_\+info.\+h.
...
\begin{DoxyCode}
156 \{
157     ROS\_INFO(\textcolor{stringliteral}{"State %s Walker transition: %s"}, sourceState->toShortName().c\_str(), 
...
160 
161     \textcolor{keywordflow}{if} (\textcolor{keyword}{typeid}(Tag) != \textcolor{keyword}{typeid}(default\_transition\_name))
162     \{
163         transitionTag = demangleSymbol<Tag>();
164         transitionType = getTransitionType<Tag>();
165         ROS\_DEBUG\_STREAM(\textcolor{stringliteral}{"TRANSITION TYPE:"} << transitionType);
166     \}
167     \textcolor{keywordflow}{else}
168     \{
169         transitionTag = \textcolor{stringliteral}{""};
170         automaticTransitionTag<Ev>(transitionTag);
171         automaticTransitionType<Ev>(transitionType);
172     \}
173 
174     ROS\_INFO\_STREAM(\textcolor{stringliteral}{"Transition tag: "} << transitionTag);
175 
176     \textcolor{keywordflow}{if} (!sourceState->stateMachine\_->containsState<Dst>())
177     \{
178         \textcolor{keyword}{auto} realparentState = sourceState->stateMachine\_->getState<\textcolor{keyword}{typename} Dst::TContext>();
179         \textcolor{keyword}{auto} siblingnode = sourceState->stateMachine\_->createState<Dst>(realparentState);
180 
181         \textcolor{comment}{//auto siblingnode = sourceState->stateMachine\_->createState<Dst>(sourceState->parentState\_);}
182         WalkStatesExecutor<Dst>::walkStates(siblingnode, \textcolor{keyword}{true});
183         sourceState->declareTransition<Ev>(siblingnode, transitionTag, transitionType, history, 
      transitionTypeInfo);
184     \}
185     \textcolor{keywordflow}{else}
186     \{
187         \textcolor{comment}{//auto realparentState = sourceState->stateMachine\_->getState<typename Dst::TContext>();}
188         \textcolor{comment}{//auto siblingnode = sourceState->stateMachine\_->createState<Dst>(realparentState);}
189 
190         \textcolor{keyword}{auto} siblingnode = sourceState->stateMachine\_->getState<Dst>();
191         sourceState->declareTransition<Ev>(siblingnode, transitionTag, transitionType, history, 
      transitionTypeInfo);
192     \}
193 \}
\end{DoxyCode}
...
Definition at line 130 of file smacc\+\_\+state\+\_\+machine\+\_\+info.\+h.
...
131 \{
132 
133     ROS\_INFO\_STREAM(\textcolor{stringliteral}{"State %s Walker has transition list"});
134     \textcolor{keyword}{using} boost::mpl::\_1;
135     \textcolor{keyword}{using} wrappedList = \textcolor{keyword}{typename} boost::mpl::transform<T, add\_type\_wrapper<\_1>>
      \hyperlink{namespacegenerate__debs_a50bc9a7ecac9584553e089a448bcde58}{::type};
136     boost::mpl::for\_each<wrappedList>(AddTransition(sourceState));
137 \}
\end{DoxyCode}
...
31     \{
32         \textcolor{keywordflow}{for} (\textcolor{keyword}{auto} &\hyperlink{namespacebattery__monitor__node_a7a63d20d1ea461e280f4eb5b47f925cd}{t} : orderedtypesdict)
33         \{
