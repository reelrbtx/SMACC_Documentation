...
Definition at line 19 of file generate\+\_\+debs.\+py.
...
\begin{DoxyCode}
126 \textcolor{keyword}{def }\hyperlink{namespacegenerate__debs_ad2e4e864bf753dbb1ed9a58436739905}{create\_smacc\_debians}(osname, osversion, rosversion):
127 
...
146     ]
147 
148     \textcolor{keywordflow}{return} \hyperlink{namespacegenerate__debs_ad76fdfddc2dad3b2dc5b98239c6125d5}{iterate\_debian\_generation}(relative\_smacc\_folder, 
...
Definition at line 157 of file generate\+\_\+debs.\+py.
...
\begin{DoxyCode}
157 \textcolor{keyword}{def }\hyperlink{namespacegenerate__debs_a1528f55b81a69cda3638628d37813bcf}{create\_smacc\_viwer\_debians}(osname, osversion, rosversion):
158     smacc\_viewer\_manual\_order\_packages = [\textcolor{stringliteral}{"smacc\_viewer"}]
159     smacc\_viewer\_debian\_files = \hyperlink{namespacegenerate__debs_ad76fdfddc2dad3b2dc5b98239c6125d5}{iterate\_debian\_generation}(
160         relative\_smacc\_viewer\_folder, smacc\_viewer\_manual\_order\_packages, osversion, rosversion)
161     \textcolor{keywordflow}{return} smacc\_viewer\_debian\_files
162 
163 
\end{DoxyCode}
...
Definition at line 96 of file generate\+\_\+debs.\+py.
...
\begin{DoxyCode}
96 \textcolor{keyword}{def }\hyperlink{namespacegenerate__debs_aa91b87c6d9c3ed04015845cc9298431a}{get\_identified\_packages}(workspace\_folder):
97     identified\_install\_packages = \{\}
98 
99     rospack = rospkg.RosPack()
100     packages = rospack.list()
101     packagesl = list(packages)
102 
103     exclude\_with\_words = [\textcolor{stringliteral}{"ridgeback"}, \textcolor{stringliteral}{"mecanum"}, \textcolor{stringliteral}{"catkin"}]
104     \textcolor{keywordflow}{for} pname \textcolor{keywordflow}{in} packagesl:
105         packpath = rospack.get\_path(pname)
106         print(pname)
107         \textcolor{keywordflow}{if} workspace\_folder \textcolor{keywordflow}{in} packpath:
108             \textcolor{keywordflow}{if} any([\textcolor{keyword}{True} \textcolor{keywordflow}{for} excludedword \textcolor{keywordflow}{in} exclude\_with\_words \textcolor{keywordflow}{if} excludedword \textcolor{keywordflow}{in} pname]):
109                 \textcolor{keywordflow}{continue}
110 
111             identified\_install\_packages[pname] = packpath
112     \textcolor{keywordflow}{return} identified\_install\_packages
113 
114 
\end{DoxyCode}
...
Definition at line 151 of file generate\+\_\+debs.\+py.


\begin{DoxyCode}
151 \textcolor{keyword}{def }\hyperlink{namespacegenerate__debs_aabab609323683db61e505e355645ab4a}{package\_io\_create\_repository}(repository\_name):
152     create\_repo\_task = subprocess.Popen(
153         \textcolor{stringliteral}{"package\_cloud repository create %d"} % repository\_name, shell=\textcolor{keyword}{True})
154     create\_repo\_task.wait()
155 
156 
\end{DoxyCode}
