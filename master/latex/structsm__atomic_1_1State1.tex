...
\begin{DoxyCode}
18     \{
19         static\_configure<OrTimer, CbTimerCountdownLoop>(3); \textcolor{comment}{// EvTimer triggers each 3 client ticks}
20         static\_configure<OrTimer, CbTimerCountdownOnce>(10); \textcolor{comment}{// EvTimer triggers once at 10 client ticks}
21     \}
\end{DoxyCode}
