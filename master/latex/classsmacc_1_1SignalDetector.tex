...
\begin{DoxyCode}
248     \{
249         \textcolor{comment}{//ros::NodeHandle nh("~"); // use node name as root of the parameter server}
250 
251         ros::NodeHandle \_;
252         ros::Rate r0(20);
253         \textcolor{keywordflow}{while} (!\hyperlink{classsmacc_1_1SignalDetector_a1b3c54963799b538078619906edd5302}{initialized\_})
254         \{
255             r0.sleep();
256         \}
257 
258         ros::NodeHandle nh(\hyperlink{namespacesmacc_1_1utils_aacd1975bb7cd9bec4b50e111a2ae7edb}{smacc::utils::cleanShortTypeName}(\textcolor{keyword}{typeid}(*this->
      \hyperlink{classsmacc_1_1SignalDetector_a46025de6ac7b5980e22144f9703236a4}{smaccStateMachine\_})));
259 
260         \textcolor{keywordflow}{if} (!nh.getParam(\textcolor{stringliteral}{"signal\_detector\_loop\_freq"}, this->loop\_rate\_hz))
261         \{
262             ROS\_WARN(\textcolor{stringliteral}{"Signal detector frequency (ros param ~signal\_detector\_loop\_freq) was not set, using
...
228                             udpatableStateElement->executeUpdate();
229                         \}
230                     \}
231                 \}
232             \}
233         \}
234         \textcolor{keywordflow}{catch} (std::exception& ex)
235         \{
236             ROS\_ERROR(\textcolor{stringliteral}{"Exception during Signal Detector update loop. %s"}, ex.what());
237         \}
238 
239         \hyperlink{classsmacc_1_1SignalDetector_a46025de6ac7b5980e22144f9703236a4}{smaccStateMachine\_}->\hyperlink{classsmacc_1_1ISmaccStateMachine_ae2e3ceb87bfe3f9d8bf320e36071fdc7}{unlockStateMachine}(\textcolor{stringliteral}{"update behaviors"});
240     \}
\end{DoxyCode}
Here is the call graph for this function\+:
\nopagebreak
