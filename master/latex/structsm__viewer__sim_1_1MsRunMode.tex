...
\begin{center}
\leavevmode
\includegraphics[width=226pt]{structsm__viewer__sim_1_1MsRunMode__inherit__graph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=226pt]{structsm__viewer__sim_1_1MsRunMode__coll__graph}
\end{center}
\end{figure}
