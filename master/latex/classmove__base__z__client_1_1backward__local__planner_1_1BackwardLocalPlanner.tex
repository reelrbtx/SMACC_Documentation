...
\begin{DoxyCode}
561 \{
562     Eigen::Vector3f new\_pos = Eigen::Vector3f::Zero();
563     new\_pos[0] = pos[0] + (vel[0] * cos(pos[2]) + vel[1] * cos(M\_PI\_2 + pos[2])) * dt;
564     new\_pos[1] = pos[1] + (vel[0] * sin(pos[2]) + vel[1] * sin(M\_PI\_2 + pos[2])) * dt;
565     new\_pos[2] = pos[2] + vel[2] * dt;
566     \textcolor{keywordflow}{return} new\_pos;
567 \}
\end{DoxyCode}
...
389 
390             ROS\_INFO(\textcolor{stringliteral}{"checking cost pt %d [%lf, %lf] cell[%d,%d] = %d"}, i, p[0], p[1], mx, my, cost);
...
408     \{
409         ROS\_WARN(\textcolor{stringliteral}{"[Abort local] Backwards global plan size: %ld"}, 
...
431         \{
432             \textcolor{keyword}{auto} waitingduration = ros::Time::now() - \hyperlink{classmove__base__z__client_1_1backward__local__planner_1_1BackwardLocalPlanner_aea0e5312bd482daafc0b8779efaf56a0}{waitingStamp\_};
433 
434             \textcolor{keywordflow}{if} (waitingduration > this->\hyperlink{classmove__base__z__client_1_1backward__local__planner_1_1BackwardLocalPlanner_a682a688c42630a6ada49ab462cec38da}{waitingTimeout\_})
435             \{
436                 ROS\_WARN(\textcolor{stringliteral}{"[Abort local] timeout! duration %lf/%f"}, waitingduration.toSec(), 
...
Definition at line 498 of file backward\+\_\+curved\+\_\+local\+\_\+planner.\+cpp.
...
\begin{DoxyCode}
499 \{
500     \textcolor{comment}{//simulate the trajectory and check for collisions, updating costs along the way}
501     \textcolor{keywordtype}{bool} end = \textcolor{keyword}{false};
502     \textcolor{keywordtype}{float} time = 0;
503     Eigen::Vector3f currentpos = pos;
504     \textcolor{keywordtype}{int} i = 0;
505     \textcolor{keywordflow}{while} (!end)
506     \{
507         \textcolor{comment}{//add the point to the trajectory so we can draw it later if we want}
508         \textcolor{comment}{//traj.addPoint(pos[0], pos[1], pos[2]);}
509 
510         \textcolor{comment}{// if (continued\_acceleration\_) \{}
511         \textcolor{comment}{//   //calculate velocities}
512         \textcolor{comment}{//   loop\_vel = computeNewVelocities(sample\_target\_vel, loop\_vel, limits\_->getAccLimits(), dt);}
513         \textcolor{comment}{//   //ROS\_WARN\_NAMED("Generator", "Flag: %d, Loop\_Vel %f, %f, %f", continued\_acceleration\_,
       loop\_vel[0], loop\_vel[1], loop\_vel[2]);}
514         \textcolor{comment}{// \}}
515 
516         \textcolor{keyword}{auto} loop\_vel = vel;
517         \textcolor{comment}{//update the position of the robot using the velocities passed in}
518         \textcolor{keyword}{auto} newpos = \hyperlink{classmove__base__z__client_1_1backward__local__planner_1_1BackwardLocalPlanner_af91f457b97d26abf9b9e2cfcbeb9d7ed}{computeNewPositions}(currentpos, loop\_vel, dt);
519 
520         \textcolor{keyword}{auto} dx = newpos[0] - currentpos[0];
521         \textcolor{keyword}{auto} dy = newpos[1] - currentpos[1];
522         \textcolor{keywordtype}{float} dist, angledist;
523 
524         \textcolor{comment}{//ROS\_INFO("traj point %d", i);}
525         dist = sqrt(dx * dx + dy * dy);
526         \textcolor{keywordflow}{if} (dist > maxdist)
527         \{
528             end = \textcolor{keyword}{true};
529             \textcolor{comment}{//ROS\_INFO("dist break: %f", dist);}
530         \}
531         \textcolor{keywordflow}{else}
532         \{
533             \textcolor{comment}{// ouble from, double to}
534             angledist = angles::shortest\_angular\_distance(currentpos[2], newpos[2]);
535             \textcolor{keywordflow}{if} (angledist > maxanglediff)
536             \{
537                 end = \textcolor{keyword}{true};
538                 \textcolor{comment}{//ROS\_INFO("angle dist break: %f", angledist);}
539             \}
540             \textcolor{keywordflow}{else}
541             \{
542                 outtraj.push\_back(newpos);
543 
544                 time += dt;
545                 \textcolor{keywordflow}{if} (time > maxtime)
546                 \{
547                     end = \textcolor{keyword}{true};
548                     \textcolor{comment}{//ROS\_INFO("time break: %f", time);}
549                 \}
550 
551                 \textcolor{comment}{//ROS\_INFO("dist: %f, angledist: %f, time: %f", dist, angledist, time);}
552             \}
553         \}
554 
555         currentpos = newpos;
556         i++;
557     \} \textcolor{comment}{// end for simulation steps}
558 \}
\end{DoxyCode}
...
Definition at line 470 of file backward\+\_\+curved\+\_\+local\+\_\+planner.\+cpp.
...
\begin{DoxyCode}
471 \{
472     \textcolor{keywordflow}{return} \hyperlink{classmove__base__z__client_1_1backward__local__planner_1_1BackwardLocalPlanner_a0a89141d3d3a8ebfb9e1d69d0d33fd49}{goalReached\_};
473 \}
\end{DoxyCode}
...
Definition at line 574 of file backward\+\_\+curved\+\_\+local\+\_\+planner.\+cpp.
