...
\item 
std\+::shared\+\_\+ptr$<$ \hyperlink{classsmacc_1_1introspection_1_1SmaccStateInfo}{smacc\+::introspection\+::\+Smacc\+State\+Info} $>$ \hyperlink{classsmacc_1_1ISmaccState_a88f44aca6998fa98c55ce6bd53c08fe4}{state\+Info\+\_\+}
\end{DoxyCompactItemize}
...
58     \{
59         ROS\_ERROR(\textcolor{stringliteral}{"Skipping client behavior creation. Orthogonal did not exist."});
60     \}
61 \}
\end{DoxyCode}
...
Definition at line 113 of file smacc\+\_\+state\+\_\+impl.\+h.
...
\begin{DoxyCode}
114 \{
115     \textcolor{keyword}{auto} sb = std::make\_shared<TStateBehavior>(\hyperlink{namespacegenerate__debs_a75f9143e38df82d83b2e8a6f99cae02c}{args}...);
116     TEventList *mock;
117     sb->initialize(\textcolor{keyword}{this}, mock);
118     sb->template setOutputEvent<TTriggerEvent>();
119     \hyperlink{classsmacc_1_1ISmaccState_ae28fb7b1f89373ca2ab382cebb0de209}{stateBehaviors\_}.push\_back(sb);
120     \textcolor{keywordflow}{return} sb;
121 \}
\end{DoxyCode}
...
\begin{DoxyCode}
104 \{
105     \textcolor{keyword}{auto} sb = std::make\_shared<TStateBehavior>(\hyperlink{namespacegenerate__debs_a75f9143e38df82d83b2e8a6f99cae02c}{args}...);
106     \textcolor{comment}{//sb->initialize(this, mock);}
107     \textcolor{comment}{//sb->setOutputEvent(typelist<TTriggerEvent>());}
108     \hyperlink{classsmacc_1_1ISmaccState_ae28fb7b1f89373ca2ab382cebb0de209}{stateBehaviors\_}.push\_back(sb);
109     \textcolor{keywordflow}{return} sb;
110 \}
\end{DoxyCode}
...
Definition at line 88 of file smacc\+\_\+state\+\_\+impl.\+h.
...
\begin{DoxyCode}
89 \{
90     \textcolor{keywordflow}{return} this->\hyperlink{classsmacc_1_1ISmaccState_a562bb3f9a3ac16b8be71e4794c9e7523}{getStateMachine}().\hyperlink{classsmacc_1_1ISmaccStateMachine_aeda2d6813c6c428bf318a5792e014b61}{getGlobalSMData}(name, ret);
91 \}
\end{DoxyCode}
...
\begin{DoxyCode}
125 \{
126     \textcolor{keywordflow}{return} this->\hyperlink{classsmacc_1_1ISmaccState_a562bb3f9a3ac16b8be71e4794c9e7523}{getStateMachine}().\hyperlink{classsmacc_1_1ISmaccStateMachine_a38b8b6e3d65b7de33020c9c397cf29bb}{getOrthogonal}<TOrthogonal>();
127 \}
\end{DoxyCode}
...
Definition at line 149 of file smacc\+\_\+state\+\_\+impl.\+h.
...
\begin{DoxyCode}
150 \{
151     \textcolor{keyword}{auto} transitionType = TypeInfo::getTypeInfoFromType<TransitionType>();
152     this->\hyperlink{classsmacc_1_1ISmaccState_acb3dd7d402c634004ae3b67a01169438}{notifyTransitionFromTransitionTypeInfo}(transitionType);
153 \}
\end{DoxyCode}
...
16     \textcolor{keyword}{auto} currstateinfo = this->\hyperlink{classsmacc_1_1ISmaccState_a88f44aca6998fa98c55ce6bd53c08fe4}{stateInfo\_};
17     
...
27             \{
28                 this->\hyperlink{classsmacc_1_1ISmaccState_a562bb3f9a3ac16b8be71e4794c9e7523}{getStateMachine}().\hyperlink{classsmacc_1_1ISmaccStateMachine_ab61bff5b3c49c4bfc17972e2de8d4fd5}{publishTransition}(transition);
...
46 
47         std::list<std::shared\_ptr<SmaccStateInfo>> ancestors;
...
Definition at line 142 of file smacc\+\_\+state\+\_\+impl.\+h.
...
\begin{DoxyCode}
143 \{
144     \hyperlink{classsmacc_1_1ISmaccState_a562bb3f9a3ac16b8be71e4794c9e7523}{getStateMachine}().\hyperlink{classsmacc_1_1ISmaccStateMachine_ad80cdd7bbc9a9f3b221c625754fed1ed}{postEvent}(ev);
145 \}
\end{DoxyCode}
...
Definition at line 72 of file smacc\+\_\+state\+\_\+impl.\+h.
...
\begin{DoxyCode}
73 \{
74     storage = \textcolor{keyword}{nullptr};
75     \textcolor{keyword}{auto} &orthogonals = this->\hyperlink{classsmacc_1_1ISmaccState_a562bb3f9a3ac16b8be71e4794c9e7523}{getStateMachine}().\hyperlink{classsmacc_1_1ISmaccStateMachine_ad6e8b109676edd2df8edf99889508bf4}{getOrthogonals}();
76     \textcolor{keywordflow}{for} (\textcolor{keyword}{auto} &ortho : orthogonals)
77     \{
78         ortho.second->requiresClient(storage);
79         \textcolor{keywordflow}{if} (storage != \textcolor{keyword}{nullptr})
80             \textcolor{keywordflow}{return};
81     \}
82 
83     ROS\_ERROR(\textcolor{stringliteral}{"Client of type '%s' not found in any orthogonal of the current state machine. This may
...
\begin{DoxyCode}
66 \{
67     this->\hyperlink{classsmacc_1_1ISmaccState_a562bb3f9a3ac16b8be71e4794c9e7523}{getStateMachine}().\hyperlink{classsmacc_1_1ISmaccStateMachine_aa6b25e28f3bce24c4b356dc865a9eb7b}{requiresComponent}(storage);
68 \}
\end{DoxyCode}
...
\begin{DoxyCode}
97 \{
98     this->\hyperlink{classsmacc_1_1ISmaccState_a562bb3f9a3ac16b8be71e4794c9e7523}{getStateMachine}().\hyperlink{classsmacc_1_1ISmaccStateMachine_a8588f9e580fbb95b53e2bd2ca3ff1f98}{setGlobalSMData}(name, value);
99 \}
\end{DoxyCode}
...
\subsubsection[{\texorpdfstring{state\+Info\+\_\+}{stateInfo_}}]{\setlength{\rightskip}{0pt plus 5cm}std\+::shared\+\_\+ptr$<${\bf smacc\+::introspection\+::\+Smacc\+State\+Info}$>$ smacc\+::\+I\+Smacc\+State\+::state\+Info\+\_\+\hspace{0.3cm}{\ttfamily [protected]}}\hypertarget{classsmacc_1_1ISmaccState_a88f44aca6998fa98c55ce6bd53c08fe4}{}\label{classsmacc_1_1ISmaccState_a88f44aca6998fa98c55ce6bd53c08fe4}
