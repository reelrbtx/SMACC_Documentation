...
Definition at line 168 of file smacc\+\_\+state\+\_\+impl.\+h.
...
\begin{DoxyCode}
169     \{
170         TEventGenerator* ret = \textcolor{keyword}{nullptr};
171         \textcolor{keywordflow}{for}(\textcolor{keyword}{auto}& evg: this->\hyperlink{classsmacc_1_1ISmaccState_a9bbef9aabd469f52c30e56b638266639}{eventGenerators\_})
172         \{
173             ret = \textcolor{keyword}{dynamic\_cast<}TEventGenerator *\textcolor{keyword}{>}(evg.get());
174             \textcolor{keywordflow}{if}(ret!=\textcolor{keyword}{nullptr})
175                 \textcolor{keywordflow}{break};
176         \}
177         \textcolor{keywordflow}{return} ret;
178     \}
\end{DoxyCode}
Here is the caller graph for this function\+:
\nopagebreak
...
\begin{DoxyCode}
162     \{
163         \textcolor{comment}{//static\_assert(boost::type\_traits::is\_base\_of<ISmaccOrthogonal,TOrthogonal>::value);}
164         \textcolor{keywordflow}{return} this->\hyperlink{classsmacc_1_1ISmaccState_a562bb3f9a3ac16b8be71e4794c9e7523}{getStateMachine}().\hyperlink{classsmacc_1_1ISmaccStateMachine_a38b8b6e3d65b7de33020c9c397cf29bb}{getOrthogonal}<TOrthogonal>();
165     \}
\end{DoxyCode}
Here is the caller graph for this function\+:
\nopagebreak
...
Definition at line 181 of file smacc\+\_\+state\+\_\+impl.\+h.
...
\begin{DoxyCode}
182     \{
183         TStateReactor* ret = \textcolor{keyword}{nullptr};
184         \textcolor{keywordflow}{for}(\textcolor{keyword}{auto}& sr: this->\hyperlink{classsmacc_1_1ISmaccState_a9bbef9aabd469f52c30e56b638266639}{eventGenerators\_})
185         \{
186             ret = \textcolor{keyword}{dynamic\_cast<}TStateReactor *\textcolor{keyword}{>}(sr.get());
187             \textcolor{keywordflow}{if}(ret!=\textcolor{keyword}{nullptr})
...
Definition at line 219 of file smacc\+\_\+state\+\_\+impl.\+h.
...
\begin{DoxyCode}
220     \{
221         \textcolor{keyword}{auto} transitionType = TypeInfo::getTypeInfoFromType<TransitionType>();
222         this->\hyperlink{classsmacc_1_1ISmaccState_acb3dd7d402c634004ae3b67a01169438}{notifyTransitionFromTransitionTypeInfo}(transitionType);
223     \}
\end{DoxyCode}
Here is the caller graph for this function\+:
\nopagebreak
...
Definition at line 206 of file smacc\+\_\+state\+\_\+impl.\+h.
...
\begin{DoxyCode}
207     \{
208         \hyperlink{classsmacc_1_1ISmaccState_a562bb3f9a3ac16b8be71e4794c9e7523}{getStateMachine}().\hyperlink{classsmacc_1_1ISmaccStateMachine_afcb6a216441aeaea2cba4e1ab12c366b}{postEvent}(ev);
209     \}
\end{DoxyCode}
Here is the caller graph for this function\+:
\nopagebreak
...
Definition at line 212 of file smacc\+\_\+state\+\_\+impl.\+h.
...
\begin{DoxyCode}
213     \{
214         \hyperlink{classsmacc_1_1ISmaccState_a562bb3f9a3ac16b8be71e4794c9e7523}{getStateMachine}().\hyperlink{classsmacc_1_1ISmaccStateMachine_afcb6a216441aeaea2cba4e1ab12c366b}{postEvent}<EventType>();
215     \}
\end{DoxyCode}
Here is the caller graph for this function\+:
\nopagebreak
