...
\begin{DoxyCode}
47 \{
48     std::string orthogonalkey = demangledTypeName<TOrthogonal>();
49     ROS\_INFO(\textcolor{stringliteral}{"[%s] Configuring orthogonal: %s"}, \hyperlink{smacc__state__impl_8h_ad0127799795db099b49dd8d9025ba574}{THIS\_STATE\_NAME}, orthogonalkey.c\_str());
50 
51     TOrthogonal *orthogonal = this->getOrthogonal<TOrthogonal>();
52     \textcolor{keywordflow}{if} (orthogonal != \textcolor{keyword}{nullptr})
53     \{
54         \textcolor{keyword}{auto} clientBehavior = std::shared\_ptr<TBehavior>(\textcolor{keyword}{new} TBehavior(\hyperlink{namespacegenerate__debs_a75f9143e38df82d83b2e8a6f99cae02c}{args}...));
55         clientBehavior->currentState = \textcolor{keyword}{this};
56         clientBehavior->template onOrthogonalAllocation<TOrthogonal, TBehavior>();
57         orthogonal->addClientBehavior(clientBehavior);
58         \textcolor{keywordflow}{return} clientBehavior;
59     \}
60     \textcolor{keywordflow}{else}
61     \{
62         ROS\_ERROR(\textcolor{stringliteral}{"[%s] Skipping client behavior creation in orthogonal [%s]. It does not exist."}, 
      \hyperlink{smacc__state__impl_8h_ad0127799795db099b49dd8d9025ba574}{THIS\_STATE\_NAME}, orthogonalkey.c\_str());
63         \textcolor{keywordflow}{return} \textcolor{keyword}{nullptr};
64     \}
65 \}
\end{DoxyCode}
...
Definition at line 129 of file smacc\+\_\+state\+\_\+impl.\+h.
...
Definition at line 160 of file smacc\+\_\+state\+\_\+impl.\+h.
...
Definition at line 153 of file smacc\+\_\+state\+\_\+impl.\+h.
...
86     \}
87 
88     ROS\_ERROR(\textcolor{stringliteral}{"[%s] Client of type '%s' not found in any orthogonal of the current state machine. This may
...
Definition at line 69 of file smacc\+\_\+state\+\_\+impl.\+h.
...
Definition at line 83 of file smacc\+\_\+state.\+h.
