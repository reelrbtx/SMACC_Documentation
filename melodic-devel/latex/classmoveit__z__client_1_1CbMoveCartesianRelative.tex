...
\mbox{\Hypertarget{classmoveit__z__client_1_1CbMoveCartesianRelative_aeffc7467b010f64ace4c7e7f699e6055}\label{classmoveit__z__client_1_1CbMoveCartesianRelative_aeffc7467b010f64ace4c7e7f699e6055}} 
...
72     \{
73         movegroupClient->postEventMotionExecutionFailed();
74         ROS\_INFO(\textcolor{stringliteral}{"[CbMoveCartesianRelative] Absolute motion planning failed. Skipping execution."});
75         \textcolor{keywordflow}{return};
76     \}
77     \textcolor{keywordflow}{else} \textcolor{keywordflow}{if}(fraction!= 1.0)
78     \{
79         ROS\_WARN\_STREAM(\textcolor{stringliteral}{"[CbMoveCartesianRelative] Cartesian plan joint-continuity percentaje: "} << 
      fraction);
80     \}
81     \textcolor{keywordflow}{else}
82     \{
83         ROS\_INFO\_STREAM(\textcolor{stringliteral}{"[CbMoveCartesianRelative] Cartesian plan joint-continuity percentaje: "} << 
      fraction);
84     \}
85 
86     moveit::planning\_interface::MoveGroupInterface::Plan grasp\_pose\_plan;
87 
88     \textcolor{comment}{//grasp\_pose\_plan.start\_state\_ = *(moveGroupInterface.getCurrentState());}
89     grasp\_pose\_plan.trajectory\_ = trajectory;
90     \textcolor{keyword}{auto} executionResult = movegroupClient->moveGroupClientInterface.execute(grasp\_pose\_plan);
91 
92     \textcolor{keywordflow}{if} (executionResult == moveit\_msgs::MoveItErrorCodes::SUCCESS)
93     \{
94         ROS\_INFO(\textcolor{stringliteral}{"[CbMoveCartesianRelative] relative motion execution succedded: fraction %lf."}, fraction);
95         movegroupClient->postEventMotionExecutionSucceded();
96     \}
97     \textcolor{keywordflow}{else}
98     \{
99         ROS\_INFO(\textcolor{stringliteral}{"[CbMoveCartesianRelative] relative motion execution failed"});
100         movegroupClient->postEventMotionExecutionFailed();
101     \}
102 
103     ROS\_INFO(\textcolor{stringliteral}{"Visualizing plan 4 (cartesian path) (%.2f%% acheived)"}, fraction * 100.0);
104 \}
\end{DoxyCode}
