...
\hline
\rowcolor{\tableheadbgcolor}\textbf{ R\+OS Distro }&\textbf{ Travis Build Status }&\textbf{ Documentation }&\textbf{ Binary Packages  }\\\cline{1-4}
\endfirsthead
\hline
\endfoot
\hline
\rowcolor{\tableheadbgcolor}\textbf{ R\+OS Distro }&\textbf{ Travis Build Status }&\textbf{ Documentation }&\textbf{ Binary Packages  }\\\cline{1-4}
\endhead
Kinetic & &\href{https://reelrbtx.github.io/SMACC_Documentation/kinetic-devel/html/namespaces.html}{\tt doxygen}& \href{https://packagecloud.io/app/reelrbtx/SMACC/search?q=kinetic&filter=all&dist=}{\tt debian files} \\\cline{1-4}
Melodic & &\href{https://reelrbtx.github.io/SMACC_Documentation/melodic-devel/html/namespaces.html}{\tt doxygen}& \href{https://packagecloud.io/app/reelrbtx/SMACC/search?q=melodic&filter=all&dist=}{\tt debian files} \\\cline{1-4}
Noetic & &\href{https://reelrbtx.github.io/SMACC_Documentation/noetic-devel/html/namespaces.html}{\tt doxygen}& \href{https://packagecloud.io/app/reelrbtx/SMACC/search?q=noetic&filter=all&dist=}{\tt debian files} \\\cline{1-4}
Master (Melodic) & &\href{https://reelrbtx.github.io/SMACC_Documentation/master/html/namespaces.html}{\tt doxygen} &-\/ \\\cline{1-4}
\end{longtabu}
