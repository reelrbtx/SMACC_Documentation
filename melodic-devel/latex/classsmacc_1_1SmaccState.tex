...
53 
54     ROS\_WARN\_STREAM(\textcolor{stringliteral}{"creating state: "} << \hyperlink{namespacesmacc_1_1introspection_a2f495108db3e57604d8d3ff5ef030302}{demangleSymbol}(\textcolor{keyword}{typeid}(MostDerived).name()).c\_str())
      ;
...
\begin{DoxyCode}
228   \{
229     \textcolor{keyword}{auto} *thisobject = \textcolor{keyword}{static\_cast<}MostDerived *\textcolor{keyword}{>}(\textcolor{keyword}{this});
230     \textcolor{keyword}{auto} condition = boost::bind(conditionFn, thisobject);
231     \textcolor{keywordtype}{bool} conditionResult = condition();
232 
233     \textcolor{comment}{//ROS\_INFO("LOOP EVENT CONDITION: %d", conditionResult);}
234     \textcolor{keywordflow}{if} (conditionResult)
235     \{
236       this->postEvent<EvLoopContinue<MostDerived>>();
237     \}
238     \textcolor{keywordflow}{else}
239     \{
240       this->postEvent<EvLoopEnd<MostDerived>>();
241     \}
242     ROS\_INFO(\textcolor{stringliteral}{"POST THROW CONDITION"});
243   \}
\end{DoxyCode}
...
301 
302     ROS\_DEBUG(\textcolor{stringliteral}{"nodehandle namespace: %s"}, \hyperlink{classsmacc_1_1ISmaccState_a13fe6e6abfdb87996402189d44b78494}{nh}.getNamespace().c\_str());
303 
...
324       \{
325         ROS\_INFO\_STREAM(\textcolor{stringliteral}{"- Creating static client behavior: "} << \hyperlink{namespacesmacc_1_1introspection_a2f495108db3e57604d8d3ff5ef030302}{demangleSymbol}(bhinfo.
      behaviorType->name()));
...
330       \{
331         ROS\_INFO\_STREAM(\textcolor{stringliteral}{"- Creating static state reactor: "} << \hyperlink{namespacesmacc_1_1introspection_a2f495108db3e57604d8d3ff5ef030302}{demangleSymbol}(sr->
      stateReactorType->name()));
332         sr->factoryFunction(\textcolor{keyword}{this});
333       \}
334 
335       ROS\_INFO(\textcolor{stringliteral}{"---- END STATIC DESCRIPTION"});
336     \}
337 
338     ROS\_INFO(\textcolor{stringliteral}{"State runtime configuration"});
339 
...
348 
349     \textcolor{comment}{// here orthogonals and client behaviors are entered OnEntry}
350     this->\hyperlink{classsmacc_1_1SmaccState_afc39f8e0ca4001b2159a100da2fccd0e}{getStateMachine}().\hyperlink{classsmacc_1_1ISmaccStateMachine_a856cf2d25d84659b974cccfbf44aeec9}{notifyOnStateEntryEnd}(
      static\_cast<MostDerived *>(\textcolor{keyword}{this}));
351   \}
\end{DoxyCode}
