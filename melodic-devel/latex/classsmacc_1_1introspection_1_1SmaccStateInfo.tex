...
Definition at line 445 of file smacc\+\_\+state\+\_\+machine\+\_\+info.\+h.


\begin{DoxyCode}
446 \{
447     \textcolor{keyword}{auto} realparentState = this->\hyperlink{classsmacc_1_1introspection_1_1SmaccStateInfo_a74685e4540842ee292a80a1db44818bb}{stateMachine\_}->getState<\textcolor{keyword}{typename} StateType::TContext>();
448 
449     \textcolor{keyword}{auto} childState = this->\hyperlink{classsmacc_1_1introspection_1_1SmaccStateInfo_a74685e4540842ee292a80a1db44818bb}{stateMachine\_}->createState<StateType>(realparentState);
450 
451     ROS\_WARN\_STREAM(\textcolor{stringliteral}{"Real parent state> "} << demangleSymbol<typename StateType::TContext>());
452 
453     \textcolor{comment}{/*auto contextInfo = TypeInfo::getTypeInfoFromType<InitialStateType>();}
454 \textcolor{comment}{    auto parentState2= getState<InitialStateType::TContext>();}
455 \textcolor{comment}{    parentState2->createChildState<InitialStateType>();*/}
456 
457     \textcolor{comment}{//this->stateMachine\_->addState(childState);}
458     \textcolor{comment}{//stateMachineInfo.addState(stateMachineInfo)}
459     \textcolor{comment}{//stateNames.push\_back(currentname);}
460     \textcolor{comment}{//ROS\_INFO("------------");}
461     \textcolor{comment}{//ROS\_INFO\_STREAM("** STATE state: "<< this->demangledStateName);}
462 
463     \textcolor{keywordflow}{return} childState;
464 \}
\end{DoxyCode}
...
Definition at line 201 of file smacc\+\_\+state\+\_\+machine\+\_\+info.\+h.
...
\begin{DoxyCode}
202 \{
203     \textcolor{keyword}{auto} evtype = demangledTypeName<EvType>();
204 
205     SmaccTransitionInfo transitionInfo;
206     transitionInfo.index = \hyperlink{classsmacc_1_1introspection_1_1SmaccStateInfo_ae8b5d8e409e377ef9a88d92fb31a8446}{transitions\_}.size();
207     transitionInfo.sourceState = shared\_from\_this();
208     transitionInfo.destinyState = dstState;
209     transitionInfo.transitionTypeInfo = transitionTypeInfo;
210 
211     \textcolor{keywordflow}{if} (transitionTag != \textcolor{stringliteral}{""})
212         transitionInfo.transitionTag = transitionTag;
213     \textcolor{keywordflow}{else}
214         transitionInfo.transitionTag = \textcolor{stringliteral}{"Transition\_"} + std::to\_string(transitionInfo.index);
215 
216     transitionInfo.transitionType = transitionType;
217     transitionInfo.historyNode = history;
218 
219     transitionInfo.eventInfo = std::make\_shared<SmaccEventInfo>(transitionTypeInfo->templateParameters.
      front());
220 
221     EventLabel<EvType>(transitionInfo.eventInfo->label);
222     ROS\_DEBUG\_STREAM(\textcolor{stringliteral}{"LABEL: "} << transitionInfo.eventInfo->label);
223 
224     \hyperlink{classsmacc_1_1introspection_1_1SmaccStateInfo_ae8b5d8e409e377ef9a88d92fb31a8446}{transitions\_}.push\_back(transitionInfo);
225 \}
\end{DoxyCode}
...
Referenced by smacc\+::introspection\+::\+Smacc\+State\+Machine\+Info\+::assemble\+S\+M\+Structure\+Message(), smacc\+::\+Smacc\+State$<$ Ss\+C\+M\+V\+Cycle, Ms\+Run, Sti\+P\+S\+Cycle\+Loop, sc\+::has\+\_\+full\+\_\+history $>$\+::entry\+State\+Internal(), and smacc\+::\+Smacc\+State$<$ Ss\+C\+M\+V\+Cycle, Ms\+Run, Sti\+P\+S\+Cycle\+Loop, sc\+::has\+\_\+full\+\_\+history $>$\+::static\+\_\+create\+State\+Reactor().
...
Referenced by smacc\+::introspection\+::\+Smacc\+State\+Machine\+Info\+::assemble\+S\+M\+Structure\+Message(), smacc\+::\+Smacc\+State$<$ Ss\+C\+M\+V\+Cycle, Ms\+Run, Sti\+P\+S\+Cycle\+Loop, sc\+::has\+\_\+full\+\_\+history $>$\+::configure\+\_\+orthogonal(), and smacc\+::\+Smacc\+State$<$ Ss\+C\+M\+V\+Cycle, Ms\+Run, Sti\+P\+S\+Cycle\+Loop, sc\+::has\+\_\+full\+\_\+history $>$\+::entry\+State\+Internal().
