...
\begin{center}
\leavevmode
\includegraphics[width=222pt]{structsm__viewer__sim_1_1EvToDeep__inherit__graph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=222pt]{structsm__viewer__sim_1_1EvToDeep__coll__graph}
\end{center}
\end{figure}
